object SarongFrm: TSarongFrm
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'DESKRIPSI'#9'70'#9'DESKRIPSI'#9'F')
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db1.item_sarong a'
      ':myparam')
    ReadBuffer = 10
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      415F4954454D010000000000090000004445534B5249505349010000000000}
    ...
    object QMasterDESKRIPSI: TStringField
      FieldName = 'DESKRIPSI'
      Size = 100
    end
  end
