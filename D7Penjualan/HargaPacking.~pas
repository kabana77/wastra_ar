...
var
  HargaPackingFrm: THargaPackingFrm;
...
procedure THargaPackingFrm.FormClose(Sender: TObject;
...
procedure THargaPackingFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure THargaPackingFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure THargaPackingFrm.LookKonstruksiEnter(Sender: TObject);
begin
//  DMFrm.QKonstruksi.Open;
end;

procedure THargaPackingFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure THargaPackingFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
//  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure THargaPackingFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure THargaPackingFrm.ECariChange(Sender: TObject);
begin
...
procedure THargaPackingFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure THargaPackingFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure THargaPackingFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure THargaPackingFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure THargaPackingFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure THargaPackingFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure THargaPackingFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure THargaPackingFrm.vHeightAfterUpClick(Sender: TObject);
begin
...
procedure THargaPackingFrm.QBrowseNewRecord(DataSet: TDataSet);
begin
...
procedure THargaPackingFrm.BitBtn2Click(Sender: TObject);
begin
  if QBrowse.Active then
  begin
    QBrowse.First;
...
procedure THargaPackingFrm.QBrowseBeforeEdit(DataSet: TDataSet);
begin
  {ShowMessage('Maaf, tidak bisa di-EDIT, buat NO TIKET baru saja !');
  Abort;}
end;

procedure THargaPackingFrm.QBrowseAfterInsert(DataSet: TDataSet);
begin
  rvdQBrowse.Execute;
end;

procedure THargaPackingFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure THargaPackingFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure THargaPackingFrm.LTitleClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure THargaPackingFrm.BitBtn3Click(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure THargaPackingFrm.TabSheet2Show(Sender: TObject);
begin
{azmi
  QRekap.Open;
...
procedure THargaPackingFrm.VTglAwal2Change(Sender: TObject);
begin
//  vTglAkhir2Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure THargaPackingFrm.VTglAkhir2Change(Sender: TObject);
begin
...
procedure THargaPackingFrm.dbcField2Enter(Sender: TObject);
var
  i : Word;
begin
...
procedure THargaPackingFrm.vOperand2Click(Sender: TObject);
begin
...
procedure THargaPackingFrm.cbOtomatis2Click(Sender: TObject);
begin
...
procedure THargaPackingFrm.cbTanggal2Click(Sender: TObject);
begin
...
procedure THargaPackingFrm.ECari2Change(Sender: TObject);
begin
{  if cbOtomatis2.Checked then
  begin
...
procedure THargaPackingFrm.BitBtn4Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure THargaPackingFrm.QBrowseAfterEdit(DataSet: TDataSet);
begin
{  QBrowseTGL_UPDATE.AsDateTime:=Now;
  QBrowseOPR_UPDATE.AsString:=DMFrm.QDateTimeUserVUSER.AsString;}
end;

procedure THargaPackingFrm.FormShow(Sender: TObject);
begin
...
procedure THargaPackingFrm.BitBtn6Click(Sender: TObject);
begin
...
procedure THargaPackingFrm.BitBtn7Click(Sender: TObject);
begin
  try
...
procedure THargaPackingFrm.LookBlendedCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure THargaPackingFrm.LookBlendedEnter(Sender: TObject);
begin
{  QBlended.Close;
  QBlended.Open;}
end;

procedure THargaPackingFrm.LookSOEnter(Sender: TObject);
begin
 { QSO.Close;
...
procedure THargaPackingFrm.LookSOCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure THargaPackingFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
{QBrowseWASTAGE.AsFloat:=(QBrowsePE_WHITE.AsFloat*QBrowseHARGA.AsFloat)+
                        (QBrowsePE_BLACK.AsFloat*QBrowseHARGA.AsFloat)+
                        (QBrowseRAYON.AsFloat*QBrowseHARGA.AsFloat);}
...
procedure THargaPackingFrm.wwDBGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure THargaPackingFrm.TabSheet3Show(Sender: TObject);
begin
