...
type
  TReprosesFrm = class(TForm)
    ...
    QCek_BJ1: TOracleDataSet;
    QCek_BJ1NAMA: TStringField;
    LookItwmmm: TwwDBLookupComboDlg;
    LookNoLot: TwwDBLookupComboDlg;
    QCek_BJ1JNS_KEMASAN: TStringField;
    QCek_BJ1SPINNING: TStringField;
    QCek_BJ1SUB_LOKASI: TStringField;
    QDetailNO_ORDER: TStringField;
    Qitem2: TOracleDataSet;
    Qitem2IBUKTI_DETAIL: TFloatField;
    Qitem2IBUKTI: TFloatField;
    Qitem2NO_BUKTI: TStringField;
    Qitem2KD_ITEM: TStringField;
    Qitem2KETERANGAN: TStringField;
    Qitem2QTY1: TFloatField;
    Qitem2QTY2: TFloatField;
    Qitem2QTY3: TFloatField;
    Qitem2QTY4: TFloatField;
    Qitem2QTY5: TFloatField;
    Qitem2QTY6: TFloatField;
    Qitem2QTY7: TFloatField;
    Qitem2QTY8: TFloatField;
    Qitem2QTY9: TFloatField;
    Qitem2QTY10: TFloatField;
    Qitem2HRG: TFloatField;
    Qitem2DISC: TFloatField;
    Qitem2SUBTOTAL: TFloatField;
    Qitem2KD_SUB_LOKASI: TStringField;
    Qitem2KD_SUB_LOKASI2: TStringField;
    Qitem2TGL_INSERT: TDateTimeField;
    Qitem2OPR_INSERT: TStringField;
    Qitem2TGL_KEBUTUHAN: TDateTimeField;
    Qitem2IBUKTI2: TFloatField;
    Qitem2ISVALID: TStringField;
    Qitem2STATUS: TStringField;
    Qitem2KD_SATUAN: TStringField;
    Qitem2KD_KEMASAN: TStringField;
    Qitem2NO_ORDER: TStringField;
    Qitem2RASIO: TFloatField;
    Qitem2SATUAN: TStringField;
    Qitem2HRG2: TFloatField;
    Qitem2NO_BUKTI_MUAT: TStringField;
    Qitem2HRG_KOREKSI: TFloatField;
    Qitem2SELISIH: TFloatField;
    Qitem2NOTA_JUAL: TStringField;
    Qitem2TGL_JTH_TMP: TDateTimeField;
    Qitem2KDSUBLOKASI_GJ: TStringField;
    Qitem2KD_SUBLOKASI_GJ2: TStringField;
    Qitem2NO_LOT: TStringField;
    Qitem2KD_TRANSAKSI: TStringField;
    Qitem2KD_KONSTRUKSI: TStringField;
    Qitem2KD_CORAK: TStringField;
    Qitem2CIS: TFloatField;
    Qitem2JNS_KEMASAN: TStringField;
    Qitem2SPINNING: TStringField;
    Qitem2PROSENTASE: TFloatField;
    Qitem2SUB_LOKASI: TStringField;
    Qitem2KETERANGAN_D: TStringField;
    Qitem2HRG_KG: TFloatField;
    Qitem2HRG2_KG: TFloatField;
    Qitem2QTY11: TFloatField;
    Qitem2NAMA: TStringField;
    QCek_BJNO_NOTA: TStringField;
    QCek_BJQTY5: TFloatField;
    QCek_BJQTY3: TFloatField;
    QCek_BJQTY1: TFloatField;
    QCek_BJSISA: TFloatField;
    ...
    OracleDataSet2NO_NOTA: TStringField;
    OracleDataSet2QTY5: TFloatField;
    OracleDataSet2QTY3: TFloatField;
    Label8: TLabel;
    Label10: TLabel;
    Label11: TLabel;
    OracleDataSet2JNS_ORDER: TStringField;
    OracleDataSet2KD_REKANAN: TFloatField;
    OracleDataSet3: TOracleDataSet;
    wwDBLookupComboDlg4: TwwDBLookupComboDlg;
    Label12: TLabel;
    Label13: TLabel;
    OracleDataSet2NAMA_REKANAN: TStringField;
    ...
    OracleDataSet3NO_NOTA: TStringField;
    OracleDataSet3MINTA: TFloatField;
    OracleDataSet3REALISASI: TFloatField;
    OracleDataSet3KURANG: TFloatField;
    ...
    procedure wwDBLookupComboDlg2UserButton1Click(Sender: TObject;
      LookupTable: TDataSet);
    procedure wwDBLookupComboDlg2CloseUp(Sender: TObject; LookupTable,
      FillTable: TDataSet; modified: Boolean);
    procedure LookItwmmmEnter(Sender: TObject);
    procedure LookItwmmmCloseUp(Sender: TObject; LookupTable,
      FillTable: TDataSet; modified: Boolean);
    procedure LookItwmmmUserButton1Click(Sender: TObject;
      LookupTable: TDataSet);
    procedure LookNoLotEnter(Sender: TObject);
...
//  if BPBFrm=Nil then
  begin
    ReprosesFrm:=TReprosesFrm.Create(Application);
    ReprosesFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       ReprosesFrm.QMaster.ReadOnly:=True;
       ReprosesFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    ReprosesFrm.vkode:=copy(pjudul,1,3);;
    ReprosesFrm.vjns_lokasi:='';
    ReprosesFrm.vjns_brg:='';
    ReprosesFrm.QTransaksi.Open;

    ReprosesFrm.Caption:=UpperCase(pjudul);
    ReprosesFrm.PanelHeader.Caption:=ReprosesFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+ReprosesFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    ReprosesFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    ReprosesFrm.wwDBGrid1.IniAttributes.SectionName:=ReprosesFrm.Caption+'1';
    ReprosesFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    ReprosesFrm.wwDBGrid1.LoadFromIniFile;
    ReprosesFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    ReprosesFrm.wwDBGrid2.IniAttributes.SectionName:=ReprosesFrm.Caption+'2';
    ReprosesFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    ReprosesFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,ReprosesFrm.Caption+'1',ReprosesFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,ReprosesFrm.Caption+'2',ReprosesFrm.wwDBGrid2);
    ReprosesFrm.wwDBSpinLine1.Value:=ReprosesFrm.wwDBGrid1.RowHeightPercent;
    ReprosesFrm.wwDBSpinLine2.Value:=ReprosesFrm.wwDBGrid2.RowHeightPercent;
...
procedure TReprosesFrm.FormClose(Sender: TObject;
...
procedure TReprosesFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TReprosesFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TReprosesFrm.BtnOkClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ...
    begin
      ...
      QBrowse.SQL.Text:='select * from '+cUserTabel+'vterimadariproduksifrm'+//'v'+Name+
...
procedure TReprosesFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TReprosesFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TReprosesFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TReprosesFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TReprosesFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TReprosesFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TReprosesFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TReprosesFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TReprosesFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TReprosesFrm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TReprosesFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TReprosesFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TReprosesFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TReprosesFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TReprosesFrm.TabSheet1Show(Sender: TObject);
begin
  vorder:='nama_kemasan';
...
procedure TReprosesFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TReprosesFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TReprosesFrm.BtnPrintInputClick(Sender: TObject);
begin
  ppReportInput.Print;
end;

procedure TReprosesFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TReprosesFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TReprosesFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TReprosesFrm.Label5Click(Sender: TObject);
begin
...
procedure TReprosesFrm.LookItemEnter(Sender: TObject);
begin
{ if DMFrm.QUserISREMOTE.AsString='1' then
     QItem.Session:=DMFrm.OSLocal     else      QItem.Session:=DMFrm.OS;   }     // QCek_BJ1.Close;      //QCek_BJ1.Open;  //QCek_BJ1.Open;  QItem.Close;  //QItem.SetVariable('nama','%'+QCek_BJ1NAMA.AsString+'%');  QItem.Open;
  //(sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TReprosesFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TReprosesFrm.QMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TReprosesFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TReprosesFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TReprosesFrm.FormCloseQuery(Sender: TObject;
...
procedure TReprosesFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TReprosesFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TReprosesFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TReprosesFrm.QProc_Update_POBeforeQuery(Sender: TOracleQuery);
begin
  QProc_Update_PO.SetVariable('NO_PO',QMasterNO_BUKTI.AsString);
end;

procedure TReprosesFrm.QLokasiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TReprosesFrm.LookLokasiEnter(Sender: TObject);
begin
  QLokasi.Open;
end;

procedure TReprosesFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
...
//  	QItem.SQL.Text:='select a.* from '+cUserTabel+'vitem2'+' a';
  ...
  { if wwDBEdit1.Text='' then
    ...
    //begin
     // QCek_BJ1.open;
     // QItem.DeclareVariable('nama',otString);
     // QItem.SetVariable('nama','%'+QCek_BJ1NAMA.AsString+'%');
      //QItem.SQL.Text:='select a.* from ipisma_db2.vitem2 a  where '+
      //' nama_item like ''%'/2'%'' order by nama_item';
     // ShowMessage('tekan kene cuy 000'); nama_item like ''%'+QCek_BJ1NAMA.AsString +'%'' and
    //end;

end;

procedure TReprosesFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
 if modified then
    QDetailNOTA_JUAL.AsString:=QItem2KETERANGAN.AsString;
end;

procedure TReprosesFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TReprosesFrm.QDetailBeforePost(DataSet: TDataSet);
begin
{  if QDetailQTY1.AsFloat>QCek_BJSISA.AsFloat then
  begin
        ShowMessage('Qty tidak dapat melebihi sisa permintaan = '+QCek_BJSISA.AsString);
        Abort;
  end; }
...
procedure TReprosesFrm.FormShow(Sender: TObject);
begin
  PanelHeader.Caption:=QTransaksiKD_TRANSAKSI.AsString+'. '+UpperCase(Caption);
QItem.Close;
end;

procedure TReprosesFrm.LookSuplierEnter(Sender: TObject);
begin
//  QCalonSuplier.Close;
...
procedure TReprosesFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
//  vorder:='nama_corak';
  QItem.Close;
...
procedure TReprosesFrm.LookItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  vorder:='nama_kemasan';
  QItem.Close;
...
procedure TReprosesFrm.TabSheet2Show(Sender: TObject);
begin
  vorder:='';
end;

procedure TReprosesFrm.ppNo2Calc(Sender: TObject;
  var Value: Variant);
begin
  Value:=Value+1;
end;

procedure TReprosesFrm.BitBtn1Click(Sender: TObject);
begin
...
procedure TReprosesFrm.LookLokasiCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QDetailKDSUBLOKASI_GJ.asstring:=LookLokasi.Text;
end;

procedure TReprosesFrm.LookSPEnter(Sender: TObject);
begin
QSP.close;
QSP.Open;
end;

procedure TReprosesFrm.LookSPCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
...
procedure TReprosesFrm.wwDBComboBox1CloseUp(
  Sender: TwwDBComboBox; Select: Boolean);
begin
QMasterJNS_ORDER.AsString:=wwDBComboBox1.Text;
end;

procedure TReprosesFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
//wwDBComboBox1.Text:='';
...
procedure TReprosesFrm.LooksubLokasiEnter(Sender: TObject);
begin
QSubLokasi.close;
QSubLokasi.open;
end;

procedure TReprosesFrm.LooksubLokasiCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 //  if modified then
...
procedure TReprosesFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotalInput.Close;
...
procedure TReprosesFrm.wwDBLookupComboDlg2Enter(Sender: TObject);
begin
OracleDataSet3.Close;
OracleDataSet3.Open;
end;

procedure TReprosesFrm.wwDBLookupComboDlg2UserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
QCek_BJ.Close;
QCek_BJ.Open;
...
procedure TReprosesFrm.wwDBLookupComboDlg2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
{QCek_BJ1.Close;
QCek_BJ1.SetVariable('bukti', OracleDataSet2NO_NOTA.AsString);
QCek_BJ1.Open;
Label34.Caption:=QCek_BJ1NAMA.AsString; }
OracleDataSet2.close;
OracleDataSet2.setvariable('nota', oracledataset3NO_NOTA.AsString);
OracleDataSet2.open;

QMasterNO_BUKTI.AsString:=OracleDataSet3NO_NOTA.AsString;
Label8.Caption:=OracleDataSet2JNS_ORDER.AsString;
Label11.Caption:=OracleDataSet2NAMA_REKANAN.AsString;

if oracledataset2JNS_ORDER.AsString='MAKLON' then
begin
...
procedure TReprosesFrm.LookItwmmmEnter(Sender: TObject);
begin
QItem.Close;
QItem.SetVariable('nama', '%'+QITEM2NAMA.AsString+'%');
QItem.Open;
end;

procedure TReprosesFrm.LookItwmmmCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
...
procedure TReprosesFrm.LookItwmmmUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
QItem.Close;
QItem.Open;
...
procedure TReprosesFrm.LookNoLotEnter(Sender: TObject);
begin
    qnO_LOT.Close;
    Qno_lot.setvariable('item', UPPERCASE(('%'+QItemNAMA_ITEM.ASstring+'%')));
    qno_lot.open;
...
procedure TReprosesFrm.wwDBLookupComboDlg3CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 if modified then
    QDetailNOTA_JUAL.AsString:=QItem2KETERANGAN.AsString;
...
procedure TReprosesFrm.wwDBLookupComboDlg3Enter(Sender: TObject);
begin
qITEM2.Close;
qItem2.Setvariable('bukti', OracleDataSet2NO_NOTA.AsString);
QItem2.Open;
end;

procedure TReprosesFrm.wwDBLookupComboDlg4Enter(Sender: TObject);
begin
QRekan.close;
QRekan.Open;
end;

procedure TReprosesFrm.wwDBLookupComboDlg4CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterKD_REKANAN.AsInteger:=QRekanKD_REKANAN.AsInteger;
label13.caption:=QRekanNAMA_REKANAN.AssTRING;
end;
