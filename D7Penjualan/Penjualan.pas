...
type
  TPenjualanFrm = class(TForm)
    ...
    LUser: TLMDLabel;
    N992SuratJalanSarong1: TMenuItem;
    N986SalesKontrakSarong1: TMenuItem;
    N11: TMenuItem;
    N773NotaPenjualanSarong1: TMenuItem;
    N12: TMenuItem;
    N770TerimaSarong1: TMenuItem;
    N772SuratJalanSarong1: TMenuItem;
    N13: TMenuItem;
    ...
    procedure N986SalesKontrakSarong1Click(Sender: TObject);
    procedure N773NotaPenjualanSarong1Click(Sender: TObject);
    procedure N772SuratJalanSarong1Click(Sender: TObject);
    procedure N770TerimaSarong1Click(Sender: TObject);
...
uses DM, TipeMenu, HakMenu, OrganisasiItem, OrganisasiLokasi,
  ...
  HargaPacking, PortCountry, RMStandartCost, Trucking, PriceRM123, Agen, RencProd, Penimbangan, SJSarong, SKSarong,
  NotaSarong, TerimaSarong, KartuStokNBB, Sarong;
...
procedure TPenjualanFrm.N986SalesKontrakSarong1Click(Sender: TObject);
begin
...
procedure TPenjualanFrm.N772SuratJalanSarong1Click(Sender: TObject);
begin
...
procedure TPenjualanFrm.N770TerimaSarong1Click(Sender: TObject);
begin
