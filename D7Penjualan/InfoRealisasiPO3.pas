...
type
  TInfoRealisasiPO3Frm = class(TForm)
...
var
  InfoRealisasiPO3Frm: TInfoRealisasiPO3Frm;
...
uses DM, Penjualan, Kriteria_Tanggal1, DCMutasiStok, DCMutasiStok2,
  KartuStok2_maklon, InfoStokGJ, InfoRealisasiPO, InfoStokGJ3,KartuStok2,
  InfoStokGJ3_laporan, InfoStokGJ2_laporan;
...
//  if InfoRealisasiPOFrm=Nil then
  begin
    InfoRealisasiPO3Frm:=TInfoRealisasiPO3Frm.Create(Application);
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;

    InfoRealisasiPO3Frm.vkode:=pkode+copy(pjudul,1,2);
    InfoRealisasiPO3Frm.vitem:=copy(pjudul,1,1);
    InfoRealisasiPO3Frm.Caption:=UpperCase(InfoRealisasiPO3Frm.PanelHeader.Caption);
    InfoRealisasiPO3Frm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    InfoRealisasiPO3Frm.wwDBGrid2.IniAttributes.SectionName:=InfoRealisasiPO3Frm.Caption+'2';
    InfoRealisasiPO3Frm.wwDBGrid2.IniAttributes.Enabled:=True;
    InfoRealisasiPO3Frm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,InfoRealisasiPO3Frm.Caption+'2',InfoRealisasiPO3Frm.wwDBGrid2);
    InfoRealisasiPO3Frm.wwDBSpinLine2.Value:=InfoRealisasiPO3Frm.wwDBGrid2.RowHeightPercent;

  end;

  InfoRealisasiPO3Frm.Show;
end;

procedure TInfoRealisasiPO3Frm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   InfoRealisasiPO3Frm:=Nil;
end;

procedure TInfoRealisasiPO3Frm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TInfoRealisasiPO3Frm.BtnExportClick(Sender: TObject);
begin
    ...
    begin
      try
        ...
        begin
          ...
          wwDBGrid1.ExportOptions.TitleName:='<font size=4>'+PanelHeader.Caption+' All'+'</font><br><font size=1>'+vTglAwal.Text+' sd '+vTglAkhir.Text+'</font>';
    ...
    begin
      try
        ...
        begin
          ...
          wwDBGrid3.ExportOptions.TitleName:='<font size=4>'+PanelHeader.Caption+' Ready to sale'+'</font><br><font size=1>'+vTglAwal.Text+' sd '+vTglAkhir.Text+'</font>';
...
procedure TInfoRealisasiPO3Frm.BtnOkClick(Sender: TObject);
var
...
procedure TInfoRealisasiPO3Frm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
...
procedure TInfoRealisasiPO3Frm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TInfoRealisasiPO3Frm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TInfoRealisasiPO3Frm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TInfoRealisasiPO3Frm.BtnFindClick(Sender: TObject);
begin
if CheckBox2.Checked=false then
begin
...
procedure TInfoRealisasiPO3Frm.BtnOk2Click(Sender: TObject);
begin
if CheckBox2.Checked=false then
begin
  if QBrowse.QBEMode then
...
procedure TInfoRealisasiPO3Frm.BtnPrintBrowseClick(Sender: TObject);
begin
...
procedure TInfoRealisasiPO3Frm.Label5Click(Sender: TObject);
begin
...
procedure TInfoRealisasiPO3Frm.LookItemEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TInfoRealisasiPO3Frm.vTglAwalChange(Sender: TObject);
begin
if vTglAwal.Date< StrToDate('01/05/2018') then
begin
  ShowMessage('Stok Awal Per 1 Mei 2018');
  vTglAwal.Date:= StrToDate('01/05/2018')
end;
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TInfoRealisasiPO3Frm.FormShow(Sender: TObject);
begin
wwDBGrid2.Visible:=True;
...
procedure TInfoRealisasiPO3Frm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if QBrowse.FieldByName(AFieldName).FieldKind=fkData then
  begin
...
procedure TInfoRealisasiPO3Frm.SpeedButton2Click(Sender: TObject);
begin
...
procedure TInfoRealisasiPO3Frm.SpeedButton1Click(Sender: TObject);
begin
  wwDBGrid2.BringToFront;
end;

procedure TInfoRealisasiPO3Frm.ppDetailBand1BeforePrint(Sender: TObject);
begin
  ppVariable1.AsInteger:=ppVariable1.AsInteger+1;
end;

procedure TInfoRealisasiPO3Frm.BitBtn1Click(Sender: TObject);
begin
  ppVariable1.AsInteger:=0;
  ppReport1.Print;
end;

procedure TInfoRealisasiPO3Frm.BitBtn2Click(Sender: TObject);
begin
...
procedure TInfoRealisasiPO3Frm.BitBtn3Click(Sender: TObject);
begin
   ...
   InfoStokGJ3_laporanFrm:=TInfoStokGJ3_laporanFrm.Create(Self);
   InfoStokGJ3_laporanFrm.Show;
end;

procedure TInfoRealisasiPO3Frm.QBrowseCalcFields(DataSet: TDataSet);
begin
  QBrowseREADY2.AsFloat:=QBrowseREADY.AsFloat-QBrowseSPB.AsFloat;
end;

procedure TInfoRealisasiPO3Frm.QBrowse2CalcFields(DataSet: TDataSet);
begin
  QBrowse2READY2.AsFloat:=QBrowse2READY.AsFloat-QBrowse2SPB.AsFloat;
end;

procedure TInfoRealisasiPO3Frm.wwDBGrid2DblClick(Sender: TObject);
begin
...
procedure TInfoRealisasiPO3Frm.Button1Click(Sender: TObject);
begin
      if QBrowse.QBEMode then
      QBrowse.QBEMode:=False;
      QBrowse.DisableControls;
...
procedure TInfoRealisasiPO3Frm.BtnFilterClick(Sender: TObject);
var
  vt1, vt2, vt3, vt4, vt5, vt6, vt7,
  vt8, vt9, vt10, vt11, vt12, vt13, vt14,
  vt15, vt16 : real;
...
procedure TInfoRealisasiPO3Frm.SpeedButton3Click(Sender: TObject);
begin
...
procedure TInfoRealisasiPO3Frm.BitBtn4Click(Sender: TObject);
begin
   InfoStokGJ3Frm:=TInfoStokGJ3Frm.Create(Self);
   InfoStokGJ3Frm.Show;
end;

procedure TInfoRealisasiPO3Frm.QBrowse4AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse4.RecNo)+' dari '+FormatFloat('#,#',QBrowse4.RecordCount)+' Records';
end;

procedure TInfoRealisasiPO3Frm.QBrowse4CalcFields(DataSet: TDataSet);
begin
  QBrowse4READY2.AsFloat:=QBrowse4READY.AsFloat-QBrowse4SPB.AsFloat;
end;

procedure TInfoRealisasiPO3Frm.wwDBGrid4TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  B,L,T,pil,M,K,S,P : string;
begin
...
procedure TInfoRealisasiPO3Frm.wwDBGrid4DblClick(Sender: TObject);
begin
