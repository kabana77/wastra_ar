object SO_WasteFrm: TSO_WasteFrm
  Left = 237
  Top = 196
  Width = 1024
  Height = 659
  ...
  object QDetail: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      0400000031000000070000004B445F4954454D01000000000004000000444953
      ...
      53490100000000000C0000004B45544552414E47414E5F44010000000000}
    Master = QMaster
    MasterFields = 'IBUKTI'
    DetailFields = 'IBUKTI'
  ...
  object QItem: TOracleDataSet
    SQL.Strings = (
        ...
        'select kd_item, nama_item, 0 as qty, '#39'01-100'#39' as kd_sub_lokasi f' +
        'rom pmtx01.item'
      'where kd_jns_item in ('#39'A'#39','#39'B'#39')'
      ''
  ...
  object QCalonSuplier: TOracleDataSet
    SQL.Strings = (
      'select * from pmtx01.rekanan_sj where isaktif=:ISAKTIF'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      414E5F414343010000000000070000004953414B544946010000000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 280
    Top = 176
  ...
  object QSatuan: TOracleDataSet
    SQL.Strings = (
        ...
        'select distinct a.satuan, a.rasio from ipisma_db2.satuan_detail ' +
        'a'
      
        'where  a.satuan is not null and rasio is not null and a.satuan i' +
        'n ('#39'BALE'#39', '#39'KILO'#39') ')
    QBEDefinition.QBEFieldDefs = {
  ...
  object QRealisasi: TOracleDataSet
    SQL.Strings = (
        ...
        'select v.no_nota, v.mu, v.status, v.kode_brg, v.nama_brg, nvl(v.' +
        'qty9,0)as qty,nvl(y.sudah_kirim,0)as sudah_kirim, nvl(x.kirim,0)' +
        'as kirim, '
    ...
    Variables.Data = {
      ...
      000000}
    QBEDefinition.QBEFieldDefs = {
      0400000009000000070000004E4F5F4E4F5441010000000000080000004E414D
      ...
      0000000B00000053554441485F4B4952494D010000000000}
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
