object HPPProduksiFrm: THPPProduksiFrm
      ...
      object TabSheet1: TTabSheet
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              'KD_ITEM'#9'16'#9'KODE'#9'F'#9'ITEM'
              'KETERANGAN'#9'20'#9'NAMA'#9'T'#9'ITEM'
              'NO_LOT'#9'20'#9'NO LOT'#9'T'
              'SPINNING'#9'10'#9'SPINNING'#9'T'
              'QTY1'#9'15'#9'HARGA'#9'F')
  ...
  object QBrowse: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      000000080000005350494E4E494E47010000000000}
    ReadOnly = True
  ...
  object QItem: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db2.item c')
    QBEDefinition.QBEFieldDefs = {
      }
    ReadOnly = True
    QueryAllRecords = False
    ...
    object QItemDISKRIPSI: TStringField
      FieldName = 'DISKRIPSI'
      Visible = False
      Size = 255
    end
    ...
    object QItemKD_LAMA: TStringField
      FieldName = 'KD_LAMA'
      Visible = False
      Size = 10
    end
    ...
    object QItemMARGIN: TFloatField
      FieldName = 'MARGIN'
      Visible = False
    end
    ...
    object QItemJNS_CUSTOMER: TStringField
  ...
  object QLot_Number: TOracleDataSet
    SQL.Strings = (
    ...
    Left = 312
    Top = 304
    object QLot_NumberLOT_NUMBER: TStringField
      FieldName = 'LOT_NUMBER'
      Required = True
    end
  end
  object dsQLot_Number: TwwDataSource
    DataSet = QLot_Number
    Left = 312
    Top = 360
  end
