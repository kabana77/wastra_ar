object KartuStok2Frm: TKartuStok2Frm
  Left = 192
  Top = 60
  Width = 1069
  Height = 640
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
        ...
        'l>=:pawal and tgl<=:pakhir '
      'and a.jns_lokasi in ('#39'READY'#39','#39'SEMENTARA'#39','#39'PEMAKAIAN'#39')')
    Variables.Data = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        '_out, sum(qty_in_kemasan) as tot_in_kem, '
      
        'sum(qty_out_kemasan) as tot_out_kem, sum(qty_in) - sum(qty_out) ' +
        'as mutasi, :awal+(sum(qty_in) - sum(qty_out)) as akhir'
    ...
    Variables.Data = {
      ...
      00000000}
    QBEDefinition.QBEFieldDefs = {
      0400000007000000040000004157414C01000000000006000000544F545F494E
      01000000000007000000544F545F4F5554010000000000060000004D55544153
      4901000000000005000000414B4849520100000000000A000000544F545F494E
      5F4B454D0100000000000B000000544F545F4F55545F4B454D010000000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 432
    Top = 144
    ...
    object QTotalTOT_IN_KEM: TFloatField
      FieldName = 'TOT_IN_KEM'
    end
    object QTotalTOT_OUT_KEM: TFloatField
      FieldName = 'TOT_OUT_KEM'
    end
  end
