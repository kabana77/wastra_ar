object PermintaanReproFrm: TPermintaanReproFrm
  Left = 267
  Top = 120
  Width = 1072
  Height = 575
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            ControlType.Strings = (
              ...
              'NO_LOT;CustomEdit;Look_NoLot2;F'
          ...
          object wwDBLookupComboDlg1: TwwDBLookupComboDlg
            ...
            OnUserButton2Click = wwDBLookupComboDlg1UserButton2Click
            Selected.Strings = (
              ...
              'SUB_LOKASI'#9'12'#9'SUB_LOKASI'#9'F'
          ...
          object Look_NoLot2: TwwDBLookupComboDlg
            Left = 160
            Top = 120
            Width = 121
            Height = 19
            ...
            UserButton1Caption = 'Urut Corak'
            UserButton2Caption = 'Urut Kemasan'
            OnUserButton1Click = Look_NoLot2UserButton1Click
            OnUserButton2Click = Look_NoLot2UserButton2Click
            Selected.Strings = (
              ...
              'AWAL'#9'10'#9'QTY STOK'#9'F'
              'KEMAS'#9'10'#9'QTY KEMAS'#9'F')
            DataField = 'NO_LOT'
            DataSource = dsQDetail
            LookupTable = Qno_lot2
            LookupField = 'KD_ITEM'
            TabOrder = 6
            AutoDropDown = True
            ShowButton = True
            AllowClearKey = False
            OnCloseUp = Look_NoLot2CloseUp
            OnEnter = Look_NoLot2Enter
          end
        end
  ...
  object QItem: TOracleDataSet
    SQL.Strings = (
      'SELECT * FROM'
        ...
        '(select * from ipisma_db2.vitem where nama_item like '#39'%'#39'||:nama|' +
        '|'#39'%'#39')'
      
        'where (kd_item like '#39'%'#39'||:pfilter||'#39'%'#39') or (nama_item like '#39'%'#39'||' +
        ':pfilter||'#39'%'#39')')
    Variables.Data = {
      0300000002000000080000003A5046494C544552050000000000000000000000
      050000003A4E414D41050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      
  ...
  object Qno_lot: TOracleDataSet
    SQL.Strings = (
      'select * from (select t.nama_rekanan,r.* from'
      
        '(select distinct b.kd_rekanan,a.kd_item, a.nama_item, a.kd_satua' +
        'n, d.satuan, sum(b.qty_in-b.qty_out) as qty, sum(b.qty_in3-b.qty' +
        '_out3) as qty_kems,'
      
        'b.kd_sub_lokasi, b.no_lot, x.kd_sub_lokasi as sub_lokasi, x.jns_' +
        'lokasi, b.spinning, b.jns_kemasan'
      
        'from ipisma_db2.item a, ipisma_db2.gd_stok b, ipisma_db2.sub_lok' +
        'asi c, ipisma_db2.satuan d, ipisma_db2.sub_sub_lokasi x'
      ''
      ''
      'where a.kd_item=b.kd_item and x.kd_sub_lokasi=b.sub_lokasi '
      
        'and b.kd_sub_lokasi= c.kd_sub_lokasi  and a.nama_item like :item' +
        ' and '
      ...
      'b.tgl<=:tgl'
        ...
        'group by b.kd_rekanan,a.kd_item, x.kd_sub_lokasi, a.nama_item, x' +
        '.jns_lokasi, b.spinning, b.jns_kemasan,b.no_lot, a.kd_satuan, d.' +
        'satuan,b.kd_sub_lokasi)r'
      ''
      
        'left outer join (select kd_rekanan, nama_rekanan from ipisma_db1' +
        '.rekanan) t on (t.kd_rekanan=r.kd_rekanan))'
      'where qty<>0 or qty_kems <> 0'
      'order by no_lot,jns_kemasan')
    Variables.Data = {
      0300000002000000050000003A4954454D050000000F00000042454E414E4720
      32342F312050560000000000040000003A54474C0C000000070000007875050A
      01010100000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      
      00000000}
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
    ...
    object Qno_lotJNS_LOKASI: TStringField
      DisplayWidth = 10
      FieldName = 'JNS_LOKASI'
      Required = True
      Size = 10
    ...
    object Qno_lotKD_SUB_LOKASI: TStringField
      FieldName = 'KD_SUB_LOKASI'
      Required = True
      Visible = False
      Size = 12
    end
    object Qno_lotQTY_KEMS: TFloatField
      FieldName = 'QTY_KEMS'
    end
  end
  ...
  object Qno_lot2: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db2.vlook_prepack t'
      ''
      '/*'
      'select * from ipisma_db2.vlook_prepack t'
      'where kd_rekanan =:vkd_rekanan'
      '*/')
    QBEDefinition.QBEFieldDefs = {
      ...
      
    ...
    object Qno_lot2SUB_LOKASI: TStringField
      DisplayWidth = 12
      FieldName = 'SUB_LOKASI'
      Size = 4
    end
    ...
    object Qno_lot2KD_SATUANL: TStringField
