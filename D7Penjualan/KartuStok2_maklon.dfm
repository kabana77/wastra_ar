object KartuStok2_maklonFrm: TKartuStok2_maklonFrm
  Left = 260
  Top = 90
  Width = 1069
  Height = 634
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'JNS_KEMASAN'#9'8'#9'JENIS'#9'F'#9'KEMASAN'
              'QTY_IN_KEMASAN'#9'8'#9'MASUK'#9'F'#9'KEMASAN'
              'QTY_OUT_KEMASAN'#9'8'#9'KELUAR'#9'F'#9'KEMASAN')
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      ...
      'where kd_item='#39'038026'#39' and lot='#39'72730/1 036'#39)
  ...
  object QDetail: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00000C0000004A4E535F4C4F4B4153495F310100000000000A0000004B445F52
      454B414E414E010000000000080000004E4F5F4E4F544132010000000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 216
    Top = 168
  ...
  object QTotalDetail: TOracleDataSet
    SQL.Strings = (
        ...
        'where a.kd_item=:kd_item and a.sub_lokasi=b.kd_sub_lokasi and tg' +
        'l>=:pawal and a.jns_lokasi in ('#39'READY'#39','#39'SEMENTARA'#39','#39'PEMAKAIAN'#39')')
    Variables.Data = {
      0300000002000000080000003A4B445F4954454D050000000700000030333830
      31300000000000060000003A504157414C0C0000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000018000000070000004B445F4954454D010000000000070000004E4F5F
      4E4F54410100000000000300000054474C0100000000000E0000004E414D415F
      5452414E53414B5349010000000000090000004449534B524950534901000000
    ...
    Left = 280
    Top = 144
    object QTotalDetailKD_ITEM: TStringField
      FieldName = 'KD_ITEM'
      Required = True
      Size = 50
    end
    object QTotalDetailNO_NOTA: TStringField
      FieldName = 'NO_NOTA'
      Required = True
      Size = 22
    end
    object QTotalDetailTGL: TDateTimeField
      FieldName = 'TGL'
      Required = True
    end
    object QTotalDetailKD_TRANSAKSI: TStringField
      FieldName = 'KD_TRANSAKSI'
      Size = 3
    end
    object QTotalDetailNAMA_TRANSAKSI: TStringField
      FieldName = 'NAMA_TRANSAKSI'
      Size = 50
    end
    object QTotalDetailDISKRIPSI: TStringField
      FieldName = 'DISKRIPSI'
      Size = 255
    end
    object QTotalDetailQTY_IN: TFloatField
      FieldName = 'QTY_IN'
    end
    object QTotalDetailQTY_IN_KEMASAN: TFloatField
      FieldName = 'QTY_IN_KEMASAN'
    end
    object QTotalDetailQTY_OUT: TFloatField
      FieldName = 'QTY_OUT'
    end
    object QTotalDetailQTY_OUT_KEMASAN: TFloatField
      FieldName = 'QTY_OUT_KEMASAN'
    end
    object QTotalDetailDEBET: TFloatField
      FieldName = 'DEBET'
      Required = True
    end
    object QTotalDetailKREDIT: TFloatField
      FieldName = 'KREDIT'
      Required = True
    end
    object QTotalDetailKD_SUB_LOKASI: TStringField
      FieldName = 'KD_SUB_LOKASI'
      Required = True
      Size = 12
    end
    object QTotalDetailKD_SUB_LOKASI2: TStringField
      FieldName = 'KD_SUB_LOKASI2'
      Size = 12
    end
    object QTotalDetailKD_LOKASI: TStringField
      FieldName = 'KD_LOKASI'
      Size = 6
    end
    object QTotalDetailJNS_LOKASI: TStringField
      FieldName = 'JNS_LOKASI'
      Required = True
      Size = 10
    end
    object QTotalDetailKDSUBLOKASI_GJ: TStringField
      FieldName = 'KDSUBLOKASI_GJ'
      Size = 12
    end
    object QTotalDetailNO_LOT: TStringField
      FieldName = 'NO_LOT'
      Size = 25
    end
    object QTotalDetailJNS_KEMASAN: TStringField
      FieldName = 'JNS_KEMASAN'
      Size = 10
    end
    object QTotalDetailSPINNING: TStringField
      FieldName = 'SPINNING'
      Size = 5
    end
    object QTotalDetailSUB_LOKASI: TStringField
      FieldName = 'SUB_LOKASI'
      Size = 4
    end
    object QTotalDetailJNS_LOKASI_1: TStringField
      FieldName = 'JNS_LOKASI_1'
      Required = True
      Size = 10
    end
