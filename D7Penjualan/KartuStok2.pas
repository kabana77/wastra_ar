...
type
  TKartuStok2Frm = class(TForm)
    ...
    Edit1: TEdit;
    QTotalTOT_IN_KEM: TFloatField;
    QTotalTOT_OUT_KEM: TFloatField;
  ...
  private
    ...
    vnomer : integer;
    vawal, vin, vout, vin_kem, vout_kem : real;
  public
    { Public declarations }
  end;

var
  KartuStok2Frm: TKartuStok2Frm;
...
//  if KartuStokFrm=Nil then
  begin
    KartuStok2Frm:=TKartuStok2Frm.Create(Application);
    mychar:=pjns;
    Delete(mychar,Pos('&',mychar),1);
    pjns:=mychar;
    KartuStok2Frm.Caption:='Barang '+pjns;
    KartuStok2Frm.vbrg:=UpperCase(pjns);
    KartuStok2Frm.vitem:=pbrg;
    KartuStok2Frm.vlot:=pno_lot;
    KartuStok2Frm.EditCari.Text:=pbrg;
    KartuStok2Frm.Edit1.Text:=pno_lot;    
    KartuStok2Frm.vjns:='';
    KartuStok2Frm.vawal:=pawal;
    KartuStok2Frm.TabSheet1Show(nil);
    KartuStok2Frm.PanelHeader.Caption:=UpperCase(pjns);
    KartuStok2Frm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KartuStok2Frm.wwDBGrid1.IniAttributes.SectionName:=KartuStok2Frm.Caption+'1';
    KartuStok2Frm.wwDBGrid1.IniAttributes.Enabled:=True;
    KartuStok2Frm.wwDBGrid1.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,KartuStok2Frm.Caption+'1',KartuStok2Frm.wwDBGrid1);
    KartuStok2Frm.wwDBSpinLine1.Value:=KartuStok2Frm.wwDBGrid1.RowHeightPercent;
  end;
  KartuStok2Frm.Show;
//  KartuStokFrm.Free;
end;

procedure TKartuStok2Frm.FormClose(Sender: TObject;
...
procedure TKartuStok2Frm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TKartuStok2Frm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TKartuStok2Frm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TKartuStok2Frm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
//  ppNo.AsInteger:=0;
end;

procedure TKartuStok2Frm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TKartuStok2Frm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.Report:=ppReportBrowse;
  ppDesigner1.ShowModal;
end;

procedure TKartuStok2Frm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TKartuStok2Frm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKartuStok2Frm.TabSheet1Show(Sender: TObject);
begin
//  EditCari.Text:=vitem;
  QMaster.Close;
...
procedure TKartuStok2Frm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TKartuStok2Frm.BtnPrintInputClick(Sender: TObject);
begin
QTotal.Close;
...
procedure TKartuStok2Frm.FormShow(Sender: TObject);
begin
  PanelHeader.Caption:=UpperCase(Caption)+' '+vbrg;
end;

procedure TKartuStok2Frm.BtnDesign1Click(Sender: TObject);
begin
  ppDesigner1.Report:=ppReportInput;
  ppDesigner1.ShowModal;
end;

procedure TKartuStok2Frm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  vnomer:=vnomer+1;
  ppNomer3.Caption:=IntToStr(vnomer);
end;

procedure TKartuStok2Frm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TKartuStok2Frm.Label14Click(Sender: TObject);
begin
...
procedure TKartuStok2Frm.BtnAmbilDataClick(Sender: TObject);
begin
      ...
      if Kriteria_Tanggal1_FRM.wwDBDateTimePicker1.Date>Kriteria_Tanggal1_FRM.wwDBDateTimePicker2.Date then
        ...
        begin
          ...
          begin
              ...
              vin_kem:=vin_kem+QDetailQTY_IN_KEMASAN.AsFloat;
              vout_kem:=vout_kem+QDetailQTY_OUT_KEMASAN.AsFloat;
              QDetail.Next;
          end;
          ...
          wwDBGrid1.ColumnByName('QTY_IN_KEMASAN').FooterValue:=FormatFloat('#0.#,#;(#0.#,#);;#',vin_kem);
          wwDBGrid1.ColumnByName('QTY_OUT_KEMASAN').FooterValue:=FormatFloat('#0.#,#;(#0.#,#);;#',vout_kem);
...
procedure TKartuStok2Frm.ppDetailBand1BeforePrint(Sender: TObject);
var
v : real;
x : string;
begin
...
procedure TKartuStok2Frm.BitBtn1Click(Sender: TObject);
begin
