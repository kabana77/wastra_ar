...
type
  TInfoRealisasiPO2Frm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelMain: TPanel;
    PanelHeader: TPanel;
...
var
  InfoRealisasiPO2Frm: TInfoRealisasiPO2Frm;
...
//  if InfoRealisasiPOFrm=Nil then
  begin
    InfoRealisasiPO2Frm:=TInfoRealisasiPO2Frm.Create(Application);
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;

    InfoRealisasiPO2Frm.vkode:=pkode+copy(pjudul,1,2);
    InfoRealisasiPO2Frm.vitem:=copy(pjudul,1,1);
    InfoRealisasiPO2Frm.Caption:=UpperCase(InfoRealisasiPO2Frm.PanelHeader.Caption);
    InfoRealisasiPO2Frm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    InfoRealisasiPO2Frm.wwDBGrid2.IniAttributes.SectionName:=InfoRealisasiPO2Frm.Caption+'2';
    InfoRealisasiPO2Frm.wwDBGrid2.IniAttributes.Enabled:=True;
    InfoRealisasiPO2Frm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,InfoRealisasiPO2Frm.Caption+'2',InfoRealisasiPO2Frm.wwDBGrid2);
    InfoRealisasiPO2Frm.wwDBSpinLine2.Value:=InfoRealisasiPO2Frm.wwDBGrid2.RowHeightPercent;

  end;

  InfoRealisasiPO2Frm.Show;
end;

procedure TInfoRealisasiPO2Frm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   InfoRealisasiPO2Frm:=Nil;
end;

procedure TInfoRealisasiPO2Frm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TInfoRealisasiPO2Frm.BtnExportClick(Sender: TObject);
begin
...
procedure TInfoRealisasiPO2Frm.BtnOkClick(Sender: TObject);
var
  vt1, vt2, vt3, vt31, vt4, vt5, vt6, vt61, vt7,
...
{azmi}
  //  HITUNGTOTAL;
      ...
      vt1:=0; vt2:=0; vt3:=0; vt31:=0; vt4:=0; vt5:=0; vt6:=0; vt61:=0; vt7:=0;
      ...
      begin
        ...
        vt61:=vt61+QBrowseP_REPRO.AsFloat;
      ...
      wwDBGrid2.ColumnByName('REPRO').FooterValue:=FormatFloat('0.0,00;(0.0,00);-',vt31);
      ...
      wwDBGrid2.ColumnByName('P_REPRO').FooterValue:=FormatFloat('0.0,00;(0.0,00);-',vt61);
...
procedure TInfoRealisasiPO2Frm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
...
procedure TInfoRealisasiPO2Frm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TInfoRealisasiPO2Frm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TInfoRealisasiPO2Frm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TInfoRealisasiPO2Frm.BtnFindClick(Sender: TObject);
begin
if CheckBox2.Checked=false then
begin
...
procedure TInfoRealisasiPO2Frm.BtnOk2Click(Sender: TObject);
begin
if CheckBox2.Checked=false then
begin
  if QBrowse.QBEMode then
...
procedure TInfoRealisasiPO2Frm.BtnPrintBrowseClick(Sender: TObject);
begin
...
procedure TInfoRealisasiPO2Frm.Label5Click(Sender: TObject);
begin
...
procedure TInfoRealisasiPO2Frm.LookItemEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TInfoRealisasiPO2Frm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TInfoRealisasiPO2Frm.FormShow(Sender: TObject);
begin
wwDBGrid2.Visible:=True;
...
procedure TInfoRealisasiPO2Frm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if QBrowse.FieldByName(AFieldName).FieldKind=fkData then
  begin
...
procedure TInfoRealisasiPO2Frm.SpeedButton2Click(Sender: TObject);
begin
...
procedure TInfoRealisasiPO2Frm.SpeedButton1Click(Sender: TObject);
begin
  wwDBGrid2.BringToFront;
end;

procedure TInfoRealisasiPO2Frm.ppDetailBand1BeforePrint(Sender: TObject);
begin
  ppVariable1.AsInteger:=ppVariable1.AsInteger+1;
end;

procedure TInfoRealisasiPO2Frm.BitBtn1Click(Sender: TObject);
begin
  ppVariable1.AsInteger:=0;
  ppReport1.Print;
end;

procedure TInfoRealisasiPO2Frm.BitBtn2Click(Sender: TObject);
begin
...
procedure TInfoRealisasiPO2Frm.BitBtn3Click(Sender: TObject);
begin
...
procedure TInfoRealisasiPO2Frm.QBrowseCalcFields(DataSet: TDataSet);
begin
...
procedure TInfoRealisasiPO2Frm.QBrowse2CalcFields(DataSet: TDataSet);
begin
  //QBrowse2READY2.AsFloat:=QBrowse2READY.AsFloat-QBrowse2SPB.AsFloat;
end;

procedure TInfoRealisasiPO2Frm.wwDBGrid2DblClick(Sender: TObject);
begin
...
procedure TInfoRealisasiPO2Frm.Button1Click(Sender: TObject);
begin
      if QBrowse.QBEMode then
      QBrowse.QBEMode:=False;
      QBrowse.DisableControls;
...
procedure TInfoRealisasiPO2Frm.BtnFilterClick(Sender: TObject);
var
...
procedure TInfoRealisasiPO2Frm.SpeedButton3Click(Sender: TObject);
begin
...
procedure TInfoRealisasiPO2Frm.BitBtn4Click(Sender: TObject);
begin
   InfoStokGJ2Frm:=TInfoStokGJ2Frm.Create(Self);
   InfoStokGJ2Frm.Show;
end;

procedure TInfoRealisasiPO2Frm.QBrowse4AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse4.RecNo)+' dari '+FormatFloat('#,#',QBrowse4.RecordCount)+' Records';
end;

procedure TInfoRealisasiPO2Frm.QBrowse4CalcFields(DataSet: TDataSet);
begin
  QBrowse4READY2.AsFloat:=QBrowse4READY.AsFloat-QBrowse4SPB.AsFloat;
end;

procedure TInfoRealisasiPO2Frm.wwDBGrid4TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
  B,L,T,pil,M,K,S,P : string;
begin
...
procedure TInfoRealisasiPO2Frm.wwDBGrid4DblClick(Sender: TObject);
begin
  KartuStok2.ShowForm('Info Kartu Stok','info Kartu Stok', QBrowse4AWAL.AsFloat,QBrowse4KD_ITEM.AsString, QBrowseNO_LOT.AsString);
end;

procedure TInfoRealisasiPO2Frm.BitBtn5Click(Sender: TObject);
var
  vt1, vt2, vt3, vt4, vt5, vt6, vt7,
  vt8, vt9, vt10, vt11, vt12, vt13, vt14,
...
procedure TInfoRealisasiPO2Frm.QBrowse5FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
...
procedure TInfoRealisasiPO2Frm.CheckBox3Click(Sender: TObject);
begin
  QBROWSE5.Filtered:=CheckBox3.Checked;
end;

procedure TInfoRealisasiPO2Frm.SpeedButton4Click(Sender: TObject);
begin
...
procedure TInfoRealisasiPO2Frm.SpeedButton5Click(Sender: TObject);
begin
  if QBrowse5.QBEMode then
  begin
    QBrowse5.ExecuteQBE;
...
procedure TInfoRealisasiPO2Frm.BitBtn7Click(Sender: TObject);
var
  vt1, vt2, vt3, vt4, vt5, vt6, vt7,
  vt8, vt9, vt10, vt11, vt12, vt13, vt14,
  vt15, vt16 : real;
...
procedure TInfoRealisasiPO2Frm.LookLokasiEnter(Sender: TObject);
begin
QLokasi.Open;
end;

procedure TInfoRealisasiPO2Frm.LookLokasiCloseUp(Sender: TObject;
...
procedure TInfoRealisasiPO2Frm.LookSubLokasiEnter(Sender: TObject);
begin
qSubLokasi.open;
end;

procedure TInfoRealisasiPO2Frm.LookSubLokasiCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
label16.Caption:=QSubLokasiJNS_LOKASI.AsString;
end;

procedure TInfoRealisasiPO2Frm.QBrowse2FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
...
procedure TInfoRealisasiPO2Frm.CheckBox4Click(Sender: TObject);
begin
  QBROWSE2.Filtered:=CheckBox4.Checked;
end;

procedure TInfoRealisasiPO2Frm.vTglAwal1Change(Sender: TObject);
begin
  vTglAkhir1.DateTime:=EndOfTheMonth(vTglAwal1.Date);
end;

procedure TInfoRealisasiPO2Frm.SpeedButton6Click(Sender: TObject);
begin
...
procedure TInfoRealisasiPO2Frm.SpeedButton7Click(Sender: TObject);
begin
  if QBrowse2.QBEMode then
  begin
    QBrowse2.ExecuteQBE;
