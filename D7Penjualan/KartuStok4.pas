...
//  if KartuStokFrm=Nil then
  begin
    KartuStok4Frm:=TKartuStok4Frm.Create(Application);
    mychar:=pjns;
    Delete(mychar,Pos('&',mychar),1);
    pjns:=mychar;
    KartuStok4Frm.Caption:='Barang '+pjns;
    KartuStok4Frm.vbrg:=UpperCase(pjns);
    KartuStok4Frm.vitem:=pbrg;
    KartuStok4Frm.vlot:=pno_lot;
    KartuStok4Frm.vsp:=psp;
    KartuStok4Frm.vlok:=plokasi;
    KartuStok4Frm.EditCari.Text:=pbrg;
    KartuStok4Frm.Edit1.Text:=pno_lot;
    KartuStok4Frm.Edit2.Text:=psp;
    KartuStok4Frm.Edit3.Text:=plokasi;
    KartuStok4Frm.vjns:='';
    KartuStok4Frm.vawal:=pawal;
    KartuStok4Frm.TabSheet1Show(nil);
    KartuStok4Frm.PanelHeader.Caption:=UpperCase(pjns);
    KartuStok4Frm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KartuStok4Frm.wwDBGrid1.IniAttributes.SectionName:=KartuStok4Frm.Caption+'1';
    KartuStok4Frm.wwDBGrid1.IniAttributes.Enabled:=True;
    KartuStok4Frm.wwDBGrid1.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,KartuStok4Frm.Caption+'1',KartuStok4Frm.wwDBGrid1);
    KartuStok4Frm.wwDBSpinLine1.Value:=KartuStok4Frm.wwDBGrid1.RowHeightPercent;
  end;
  KartuStok4Frm.Show;
//  KartuStokFrm.Free;
end;

procedure TKartuStok4Frm.FormClose(Sender: TObject;
...
procedure TKartuStok4Frm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TKartuStok4Frm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TKartuStok4Frm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TKartuStok4Frm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
//  ppNo.AsInteger:=0;
end;

procedure TKartuStok4Frm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TKartuStok4Frm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.Report:=ppReportBrowse;
  ppDesigner1.ShowModal;
end;

procedure TKartuStok4Frm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TKartuStok4Frm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKartuStok4Frm.TabSheet1Show(Sender: TObject);
begin
//  EditCari.Text:=vitem;
  QMaster.Close;
...
procedure TKartuStok4Frm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TKartuStok4Frm.BtnPrintInputClick(Sender: TObject);
begin
QTotal.Close;
...
procedure TKartuStok4Frm.FormShow(Sender: TObject);
begin
  PanelHeader.Caption:=UpperCase(Caption)+' '+vbrg;
end;

procedure TKartuStok4Frm.BtnDesign1Click(Sender: TObject);
begin
  ppDesigner1.Report:=ppReportInput;
  ppDesigner1.ShowModal;
end;

procedure TKartuStok4Frm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  vnomer:=vnomer+1;
  ppNomer3.Caption:=IntToStr(vnomer);
end;

procedure TKartuStok4Frm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TKartuStok4Frm.Label14Click(Sender: TObject);
begin
...
procedure TKartuStok4Frm.BtnAmbilDataClick(Sender: TObject);
begin
      ...
      if Kriteria_Tanggal1_FRM.wwDBDateTimePicker1.Date>Kriteria_Tanggal1_FRM.wwDBDateTimePicker2.Date then
        ...
        begin
          ...
          QDetail.SQL.Text:='select a.*, b.jns_lokasi as jns_lokasi_1 from '+cUserTabel+'vkartu_stok a, ipisma_db2.sub_sub_lokasi b '+
            ' where a.kd_item=:kd_item and a.sub_lokasi=:lok and a.spinning=:sp and a.no_lot=:lot and a.sub_lokasi=b.kd_sub_lokasi and a.tgl>=:pawal and a.tgl<=:pakhir and a.jns_lokasi in (''READY'',''SEMENTARA'',''PEMAKAIAN'')';
...
procedure TKartuStok4Frm.ppDetailBand1BeforePrint(Sender: TObject);
var
v : real;
x : string;
begin
...
procedure TKartuStok4Frm.BitBtn1Click(Sender: TObject);
begin
