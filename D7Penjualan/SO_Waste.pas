...
//  if SOFrm=Nil then
  begin
    SO_WasteFrm:=TSO_WasteFrm.Create(Application);
    KemasanFoto4Frm:=TKemasanFoto4Frm.Create(Application);
    SO_WasteFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       SO_WasteFrm.QMaster.ReadOnly:=True;
       SO_WasteFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    SO_WasteFrm.Caption:=UpperCase(pjudul);
    SO_WasteFrm.vkode:=copy(pjudul,1,3);
    SO_WasteFrm.QTransaksi.Open;
    SO_WasteFrm.PanelHeader.Caption:=SO_WasteFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+SO_WasteFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    SO_WasteFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    SO_WasteFrm.wwDBGrid1.IniAttributes.SectionName:=SO_WasteFrm.Caption+'1';
    SO_WasteFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    SO_WasteFrm.wwDBGrid1.LoadFromIniFile;
    SO_WasteFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    SO_WasteFrm.wwDBGrid2.IniAttributes.SectionName:=SO_WasteFrm.Caption+'2';
    SO_WasteFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    SO_WasteFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,SO_WasteFrm.Caption+'1',SO_WasteFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,SO_WasteFrm.Caption+'2',SO_WasteFrm.wwDBGrid2);
    SO_WasteFrm.wwDBSpinLine1.Value:=SO_WasteFrm.wwDBGrid1.RowHeightPercent;
    SO_WasteFrm.wwDBSpinLine2.Value:=SO_WasteFrm.wwDBGrid2.RowHeightPercent;
...
procedure TSO_WasteFrm.FormClose(Sender: TObject;
...
procedure TSO_WasteFrm.FormCreate(Sender: TObject);
begin
...
procedure TSO_WasteFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TSO_WasteFrm.BtnOkClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ...
    begin
      ...
      QBrowse.SQL.Text:='select * from '+cUserTabel+'vso_wastefrm'+
...
procedure TSO_WasteFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TSO_WasteFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TSO_WasteFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TSO_WasteFrm.vTglAwalChange(Sender: TObject);
begin
    vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TSO_WasteFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TSO_WasteFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TSO_WasteFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TSO_WasteFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=0;
end;

procedure TSO_WasteFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TSO_WasteFrm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TSO_WasteFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TSO_WasteFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TSO_WasteFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TSO_WasteFrm.QDetailCalcFields(DataSet: TDataSet);
begin
if QSatuanSATUAN.AsString='KILO' then
  BEGIN
  QDetailSUB_TOTAL.AsFloat:=(QDetailHRG2.AsFloat*1)*(1-QDetailDISC.AsFloat/100)*(QDetailCIS.AsFloat*1);
  end;
if QSatuanSATUAN.AsString='BALE' then
  BEGIN
  QDetailSUB_TOTAL.AsFloat:=(QDetailHRG.AsFloat*1)*(1-QDetailDISC.AsFloat/100)*(QDetailQTY7.AsFloat*1);
  end;
end;

procedure TSO_WasteFrm.EditCariKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TSO_WasteFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TSO_WasteFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TSO_WasteFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
...
//  ShowMessage(QTotalInput.SQL.Text);
  ...
  1 : begin
        vdpp:=vsub_total/vkonst_pjk_dpp;
...
procedure TSO_WasteFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TSO_WasteFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
  DMFrm.QTime.Close;
  DMFrm.QTime.Open;
...
procedure TSO_WasteFrm.BtnPrintInputClick(Sender: TObject);
begin
...
procedure TSO_WasteFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
if QMasterINC_PPN.AsString='3' then
QMasterISPJK.AsString:='1';

if QMasterINC_PPN.AsString='4' then
QMasterISPJK.AsString:='1';
...
procedure TSO_WasteFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TSO_WasteFrm.wwDBGrid1Enter(Sender: TObject);
begin
  QItem.Close;
  qitem.open;
...
procedure TSO_WasteFrm.wwDBGrid2DblClick(Sender: TObject);
begin
//  TabSheet1.Show;
end;

procedure TSO_WasteFrm.Label5Click(Sender: TObject);
begin
...
procedure TSO_WasteFrm.LookItemEnter(Sender: TObject);
begin
...
//  (sender as TwwDBLookupComboDlg).LookupTable.Open;
{
    ...
    QItem.SQL.Text:='select a.kd_item, a.nama_item , sum(a.qty_in-a.qty_out) as qty, '+ //a.jns_koreksi as keterangan_d,
                    ...
                    '''01-100'' as kd_sub_lokasi'+//,a.harga as hrg_jual,
                    ' from ipisma_db2.vkartu_stok2 a where  a.tanggal<=:TGL and (a.kd_item like ''A%'' or a.kd_item like ''B%'')'+ //a.harga as hrg
                    'group by a.kd_item,a.nama_item';         //,a.jns_koreksi, a.kd_sub_lokasi, a.harga
                    }
    QItem.close;
    QItem.Open;
end;

procedure TSO_WasteFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TSO_WasteFrm.QMasterNewRecord(DataSet: TDataSet);
begin
  ...
  QMasterJNS_ORDER.AsString:='WASTE';
...
procedure TSO_WasteFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TSO_WasteFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
{  if modified then
    begin
...
procedure TSO_WasteFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
   vorder:='nama_item';
...
procedure TSO_WasteFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TSO_WasteFrm.QMasterAfterScroll(DataSet: TDataSet);
begin
  wwDBGrid1UpdateFooter(nil);
end;

procedure TSO_WasteFrm.QMasterINC_PPNChange(Sender: TField);
begin
  wwDBGrid1UpdateFooter(nil);
end;

procedure TSO_WasteFrm.LookSuplierCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
...
if   wwDBComboBox2.itemindex=-1 then
  ...
  begin
    ...
    QMasterSOPIR.AsString:=QCalonSuplierKD_REKANAN.AsString;
    //QMasterLALAMAT.AsString:=QCalonSuplierALAMAT.AsString;
...
procedure TSO_WasteFrm.LookSuplierEnter(Sender: TObject);
begin
{if DMFrm.QUserISREMOTE.AsString='1' then
 ...
 // end;  }
  ...
  QCalonSuplier.SQL.Text:='select * from pmtx01.rekanan_sj where isaktif=:isaktif order by nama_rekanan';
  QCalonSuplier.Open;
end;

procedure TSO_WasteFrm.wwDBLookupCombo1CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
...
procedure TSO_WasteFrm.QMasterNHARIChange(Sender: TField);
begin
  if QMasterTGL_KIRIM.AsString<>'' then
    QMasterTGL_JTH_TEMPO.AsDateTime:=QMasterTGL_KIRIM.AsDateTime+QMasterNHARI.AsInteger;
end;

procedure TSO_WasteFrm.QMasterTGL_KIRIMChange(Sender: TField);
begin
    QMasterTGL_JTH_TEMPO.AsDateTime:=QMasterTGL_KIRIM.AsDateTime+QMasterNHARI.AsInteger;
end;

procedure TSO_WasteFrm.FormCloseQuery(Sender: TObject;
...
procedure TSO_WasteFrm.QMasterAfterPost(DataSet: TDataSet);
begin
  PageControl1.Pages[1].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
  PageControl1.Pages[2].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
end;

procedure TSO_WasteFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TSO_WasteFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TSO_WasteFrm.TabSheet2Show(Sender: TObject);
begin
  vorder:='';
...
procedure TSO_WasteFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure TSO_WasteFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TSO_WasteFrm.wwDBBatasKreditDblClick(Sender: TObject);
begin
...
procedure TSO_WasteFrm.QMasterCalcFields(DataSet: TDataSet);
begin
  QMasterSISA_KREDIT.AsFloat:=QMasterDEPOSIT.AsFloat+QMasterBATAS_KREDIT.AsFloat-
    QMasterOUTSTANDING.AsFloat;
end;

procedure TSO_WasteFrm.QDetailQTY3Change(Sender: TField);
begin
  QDetailQTY6.AsFloat:=QDetailRASIO.AsFloat*
    QDetailQTY3.AsFloat;
end;

procedure TSO_WasteFrm.QOutLineNewRecord(DataSet: TDataSet);
begin
...
procedure TSO_WasteFrm.wwDBLookupComboDlg2Enter(Sender: TObject);
begin
  LMaterial.Open;
end;

procedure TSO_WasteFrm.TabSheet5Show(Sender: TObject);
begin
{  QOutLine.Close;
...
procedure TSO_WasteFrm.wwDBLookupCombo2CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
...
procedure TSO_WasteFrm.wwDBLookupComboDlg2CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
...
procedure TSO_WasteFrm.CheckBox1Click(Sender: TObject);
begin
...
procedure TSO_WasteFrm.CheckBox2Click(Sender: TObject);
begin
...
procedure TSO_WasteFrm.QDetailAfterScroll(DataSet: TDataSet);
begin
  if CheckBox2.Checked then
  begin
    KemasanFoto4Frm.QFoto.Close;
...
procedure TSO_WasteFrm.QOutLineAfterScroll(DataSet: TDataSet);
begin
  if CheckBox2.Checked then
  begin
    KemasanFoto4Frm.QFoto.Close;
...
procedure TSO_WasteFrm.wwDBEdit5Click(Sender: TObject);
{var
  vharga : string; }
begin
 { vharga:='0';
...
procedure TSO_WasteFrm.wwDBLookupComboDlg3Enter(Sender: TObject);
begin
   DMFrm.QEkspedisi.Open;
end;

procedure TSO_WasteFrm.ppSummaryBand2BeforePrint(Sender: TObject);
begin
...
procedure TSO_WasteFrm.QSatuanBeforeOpen(DataSet: TDataSet);
begin

 // QSatuan.SetVariable('kd_satuan',QDetailKD_SATUAN.AsString);
end;

procedure TSO_WasteFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TSO_WasteFrm.LookSatuanCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TSO_WasteFrm.BtnPrintInput2Click(Sender: TObject);
VAR
NOM : STRING;
begin
 {azmi}
...
procedure TSO_WasteFrm.ppTitleBand4BeforePrint(Sender: TObject);
begin
  ppNo3.AsInteger:=1;
end;

procedure TSO_WasteFrm.ppTitleBand2BeforePrint(Sender: TObject);
begin
  ppLPPn.Caption:='PPN : '+wwDBComboBox1.Text;
  ppNo2.AsInteger:=1;
end;

procedure TSO_WasteFrm.ppFooterBand4BeforePrint(Sender: TObject);
begin
  DMFrm.QTime.Close;
  DMFrm.QTime.Open;
...
procedure TSO_WasteFrm.TabSheet6Show(Sender: TObject);
begin
...
procedure TSO_WasteFrm.QDetail3CalcFields(DataSet: TDataSet);
begin
...
procedure TSO_WasteFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  vorder:='nama_corak';
  QItem.Close;
...
procedure TSO_WasteFrm.LookItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  vorder:='nama_item';
  QItem.Close;
...
procedure TSO_WasteFrm.ppNo2Calc(Sender: TObject; var Value: Variant);
begin
  Value:=Value+1;
end;

procedure TSO_WasteFrm.ppNo3Calc(Sender: TObject; var Value: Variant);
begin
  Value:=Value+1;
end;

procedure TSO_WasteFrm.wwDBGrid2URLOpen(Sender: TObject; var URLLink: String;
  Field: TField; var UseDefault: Boolean);
var
...
procedure TSO_WasteFrm.LookSatuanEnter(Sender: TObject);
begin
if DMFrm.QUserISREMOTE.AsString='1' then
...
procedure TSO_WasteFrm.wwDBLookupComboDlg4Enter(Sender: TObject);
begin
{azmi}
  QUM.Close;
...
procedure TSO_WasteFrm.wwDBLookupComboDlg4CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
{azmi}
  if modified then
...
procedure TSO_WasteFrm.wwDBComboBox2Change(Sender: TObject);
begin
...
procedure TSO_WasteFrm.LookLokasiEnter(Sender: TObject);
begin
 QLokasi.Open;
end;

procedure TSO_WasteFrm.LookLokasiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TSO_WasteFrm.wwDBComboBox4CloseUp(Sender: TwwDBComboBox;
  Select: Boolean);
begin
...
procedure TSO_WasteFrm.BitBtn1Click(Sender: TObject);
begin
QRealisasi.Close;
...
procedure TSO_WasteFrm.vTglAwal1Change(Sender: TObject);
begin
  vTglAkhir1.DateTime:=EndOfTheMonth(vTglAwal1.Date);
end;

procedure TSO_WasteFrm.QRealisasiAfterScroll(DataSet: TDataSet);
begin
  LabelBanner1.Caption:='Record ke '+IntToStr(QRealisasi.RecNo)+' dari '+FormatFloat('#,#',QRealisasi.RecordCount)+' Records';
end;

procedure TSO_WasteFrm.SpeedButton1Click(Sender: TObject);
begin
...
procedure TSO_WasteFrm.SpeedButton2Click(Sender: TObject);
begin
...
procedure TSO_WasteFrm.BitBtn5Click(Sender: TObject);
begin
Close;
end;

procedure TSO_WasteFrm.wwDBGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TSO_WasteFrm.wwDBComboBox1Change(Sender: TObject);
begin
if QMasterINC_PPN.AsString='0' then
QMasterISPJK.AsString:='0';
...
procedure TSO_WasteFrm.BitBtn6Click(Sender: TObject);
begin
QSOvsSPKB.Close;
...
procedure TSO_WasteFrm.vtgl1Change(Sender: TObject);
begin
  vTgl2.DateTime:=EndOfTheMonth(vTgl1.Date);
end;

procedure TSO_WasteFrm.TabSheet8Show(Sender: TObject);
begin
QmASTER.oPEN;
end;

procedure TSO_WasteFrm.QSOvsSPKBAfterScroll(DataSet: TDataSet);
begin
  Label47.Caption:='Record ke '+IntToStr(QSOvsSPKB.RecNo)+' dari '+FormatFloat('#,#',QSOvsSPKB.RecordCount)+' Records';
end;

procedure TSO_WasteFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
