...
type
  TNotaSarongFrm = class(TForm)
    ...
    QDetailSUBTOTAL2: TFloatField;
    QLookItem2KD_ITEM: TStringField;
    QLookItem2NAMA_ITEM: TStringField;
    QLookItem2NO_NOTA: TStringField;
    QLookItem2QTY: TFloatField;
    QLookItem2HRG: TFloatField;
    QLookItem2POT_HRG: TFloatField;
    QLookItem2SUBTOTAL: TFloatField;
    QRLabel12: TQRLabel;
    QRDBText15: TQRDBText;
    QDetailVSUBTOTAL: TIntegerField;
    QRLabel53: TQRLabel;
    QRLabel54: TQRLabel;
    QRLabel55: TQRLabel;
    QRLabel56: TQRLabel;
    ...
    QRShape1: TQRShape;
    VVDPP: TQRLabel;
    QTotalPOT_HRG2: TFloatField;
    QTotalSUBTOTAL2: TFloatField;
    QTotalSUBTOTAL: TFloatField;
    ...
    procedure QDetailHRG2Change(Sender: TField);
    procedure QDetailPOT_HRG2Change(Sender: TField);
...
procedure TNotaSarongFrm.FormClose(Sender: TObject;
...
procedure TNotaSarongFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TNotaSarongFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TNotaSarongFrm.LookKonstruksiEnter(Sender: TObject);
begin
  //DMFrm.QKonstruksi.Open;
end;

procedure TNotaSarongFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TNotaSarongFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
//  wwDBGrid2.SetFocus;
...
procedure TNotaSarongFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TNotaSarongFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  //QSuplier.Close;
...
procedure TNotaSarongFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
 ...
 if (FormatDateTime('YYMM',QTransaksiTGL.AsDateTime)<>copy(QTransaksiNO_NOTA.AsString,5,4)) then QTransaksiNO_NOTA.AsString:='';
  ...
  begin
      ...
      begin
          DMFrm.FNoUrut.Close;
          DMFrm.FNoUrut.SetVariable(0, '773');
...
procedure TNotaSarongFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TNotaSarongFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TNotaSarongFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TNotaSarongFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TNotaSarongFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TNotaSarongFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TNotaSarongFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TNotaSarongFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TNotaSarongFrm.ECariChange(Sender: TObject);
begin
...
procedure TNotaSarongFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TNotaSarongFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TNotaSarongFrm.FormShow(Sender: TObject);
begin
...
procedure TNotaSarongFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TNotaSarongFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vnomer:=0;
...
procedure TNotaSarongFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TNotaSarongFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TNotaSarongFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TNotaSarongFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  ...
  if QTransaksiPPN.AsString='0' then QRLPPN.Caption:='TANPA PPN';
  if QTransaksiPPN.AsString='1' then QRLPPN.Caption:='INCLUDE';
  if QTransaksiPPN.AsString='2' then QRLPPN.Caption:='EXCLUDE';

end;

procedure TNotaSarongFrm.FormCloseQuery(Sender: TObject;
...
procedure TNotaSarongFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TNotaSarongFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
...
procedure TNotaSarongFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
  QDetailVSUBTOTAL.AsFloat:=QDetailQTY.AsFloat*QDetailHRG2.AsFloat;
end;

procedure TNotaSarongFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TNotaSarongFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TNotaSarongFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TNotaSarongFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TNotaSarongFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TNotaSarongFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TNotaSarongFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TNotaSarongFrm.BtnExportClick(Sender: TObject);
begin
{azmi}
  case PageControl1.ActivePageIndex of
  0 :
...
procedure TNotaSarongFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TNotaSarongFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TNotaSarongFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TNotaSarongFrm.BtnFormulasiClick(Sender: TObject);
begin
...
procedure TNotaSarongFrm.Label3Click(Sender: TObject);
begin
  {DMFrm.QSisdur.Close;
...
procedure TNotaSarongFrm.LookSuplierCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
var
  vkota : string;
begin
...
procedure TNotaSarongFrm.LookSuplierEnter(Sender: TObject);
begin
 QSuplier.close;
 QSuplier.SetVariable('kd_rekanan', QKontrakKD_REKANAN.AsInteger);
 QSuplier.Open;
...
procedure TNotaSarongFrm.LookSuplierUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QKontrak.Close;
...
procedure TNotaSarongFrm.LookMUEnter(Sender: TObject);
begin
  DMFrm.QMU.Open;
end;

procedure TNotaSarongFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
//  QTotal.Close;
...
procedure TNotaSarongFrm.QuickRep2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vdpp:=0;
  vppn:=0;
...
procedure TNotaSarongFrm.PageHeaderBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  vfirst_page:=False;
end;

procedure TNotaSarongFrm.QBrowseDetailBeforeOpen(DataSet: TDataSet);
begin
//  QBrowseDetail.SetVariable('no_reg_po',QBrowseNO_REG_PO.AsInteger);
end;

procedure TNotaSarongFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TNotaSarongFrm.QSuplierBeforeOpen(DataSet: TDataSet);
begin
...
procedure TNotaSarongFrm.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vnomer);
...
procedure TNotaSarongFrm.BitBtn4Click(Sender: TObject);
begin
...
procedure TNotaSarongFrm.wwDBDateTimePicker1Change(Sender: TObject);
begin
//btnformulasi.Click;
 { if QTransaksi.State<>dsBrowse then
   try
...
procedure TNotaSarongFrm.QTransaksiAfterCancel(DataSet: TDataSet);
begin
wwDBDateTimePicker1.Enabled:=true;
end;

procedure TNotaSarongFrm.Btn_filterClick(Sender: TObject);
...
procedure TNotaSarongFrm.Vtglawal2Change(Sender: TObject);
begin
 vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));

end;

procedure TNotaSarongFrm.Vtglakhir2Change(Sender: TObject);
begin
...
procedure TNotaSarongFrm.dbcfield2Enter(Sender: TObject);
...
procedure TNotaSarongFrm.cbotomatis2Click(Sender: TObject);
begin
...
procedure TNotaSarongFrm.ecari2Change(Sender: TObject);
begin
  if cbOtomatis2.Checked then
  begin
...
procedure TNotaSarongFrm.wwDBGrid3DblClick(Sender: TObject);
...
procedure TNotaSarongFrm.wwDBGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
 if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TNotaSarongFrm.Qbrowse2BeforeOpen(DataSet: TDataSet);
begin
// QBrowse2.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TNotaSarongFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure TNotaSarongFrm.Voperand2Click(Sender: TObject);
begin
{azmi}
  if vOperand2.Caption='LIKE' then
    vOperand2.Caption:='='
...
procedure TNotaSarongFrm.cbtanggal2Click(Sender: TObject);
begin
  if cbTanggal2.Checked then
  begin
...
procedure TNotaSarongFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TNotaSarongFrm.wwDBGrid4CalcCellColors(Sender: TObject;
  Field: TField; State: TGridDrawState; Highlight: Boolean; AFont: TFont;
  ABrush: TBrush);
begin
{  if not Highlight then
...
procedure TNotaSarongFrm.wwDBGrid4DblClick(Sender: TObject);
var
  vnama_barang_org : String;
  vketerangan_org : String;
  vpos : Integer;
...
procedure TNotaSarongFrm.wwDBGrid4Enter(Sender: TObject);
begin
  if QTransaksi.State<>dsBrowse then
        try
          QTransaksi.Post;
...
procedure TNotaSarongFrm.LookSarongEnter(Sender: TObject);
begin
  QLookItem2.Close;
...
procedure TNotaSarongFrm.QDetailAfterQuery(Sender: TOracleDataSet);
begin
{  QDetailKD_ITEM2.AsString:=QDetailKD_ITEM.AsString;
  QDetailKD_proyek.AsString:=QDetailKETERANGAN.AsString;}
end;

procedure TNotaSarongFrm.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TNotaSarongFrm.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TNotaSarongFrm.LookSarongCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin

  QDetailNAMA_ITEM.AsString:=QLookItem2NAMA_ITEM.AsString;
  QDetailNO_REFF.AsString:=QLookItem2NO_NOTA.AsString;
  QDetailIQTY_SDH_KIRIM.AsFloat:=QLookItem2QTY.AsFloat;
  QDetailHRG.AsFloat:=QLookItem2HRG.AsFloat;
  QDetailPOT_HRG.AsFloat:=QLookItem2POT_HRG.AsFloat;
  QDetailSUBTOTAL.AsFloat:=QLookItem2SUBTOTAL.AsFloat;

  QDetailQTY.AsFloat:=QLookItem2QTY.AsFloat;
  QDetailHRG2.AsFloat:=QLookItem2HRG.AsFloat;
  QDetailPOT_HRG2.AsFloat:=QLookItem2POT_HRG.AsFloat;

end;

procedure TNotaSarongFrm.LookSarongUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem2.Close;
...
procedure TNotaSarongFrm.wwDBComboBox1Change(Sender: TObject);
begin
  if QTransaksiPPN.AsString='0' then QTransaksiISPJK.AsString:='0' else QTransaksiISPJK.AsString:='1';
end;

procedure TNotaSarongFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailPOT_HRG.AsFloat:=0;
end;

procedure TNotaSarongFrm.QDetailQTYChange(Sender: TField);
var
  vqty, vhrg, vpot : Double;
begin
  vqty:=QDetailQTY.AsFloat;
  vhrg:=QDetailHRG2.AsFloat;
  vpot:=QDetailPOT_HRG2.AsFloat;
  QDetailSUBTOTAL2.AsFloat:=(vqty*vhrg)-vpot;
end;

procedure TNotaSarongFrm.QDetailHRGChange(Sender: TField);
var
  vqty, vhrg, vpot : Double;
begin
  vqty:=QDetailQTY.AsFloat;
...
procedure TNotaSarongFrm.QDetailPOT_HRGChange(Sender: TField);
var
  vqty, vhrg, vpot : Double;
begin
  vqty:=QDetailQTY.AsFloat;
...
procedure TNotaSarongFrm.wwDBEdit3Change(Sender: TObject);
begin
...
procedure TNotaSarongFrm.QDetailHRG2Change(Sender: TField);
var
  vqty, vhrg, vpot : Double;
begin
  vqty:=QDetailQTY.AsFloat;
...
procedure TNotaSarongFrm.QDetailPOT_HRG2Change(Sender: TField);
var
  vqty, vhrg, vpot : Double;
begin
  vqty:=QDetailQTY.AsFloat;
...
procedure TNotaSarongFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var vvtdpp, vvtppn, vvttotal : Double;
begin

  QTotal.Close;
  QTotal.SetVariable('itrx', QTransaksiITRX.AsInteger);
  QTotal.Open;

  if QTransaksiPPN.AsString = '1' then
  begin
    vvtdpp := QTotalSUBTOTAL2.AsFloat / 1.11;
    vvtppn := vvtdpp * 0.11;
    vvttotal := vvtdpp + vvtppn;
  end
  else if QTransaksiPPN.AsString = '2' then
  begin
    vvtdpp := QTotalSUBTOTAL2.AsFloat;
    vvtppn := vvtdpp * 0.11;
    vvttotal := vvtdpp + vvtppn;
  end
  else
  ...
  DMFrm.MyKonversi1.Nilai:=vvttotal;
  QRLTerbilang.Caption:='Terbilang : #'+DMFrm.MyKonversi1.HasilKonversi+'#';

  VVDPP.Caption:=FormatFloat('#,##0.##;(#,##0.##)',vvtdpp);
  VVPPN.Caption:=FormatFloat('#,##0.##;(#,##0.##)',vvtppn);
  VVTTL.Caption:=FormatFloat('#,##0.##;(#,##0.##)',vvttotal);
