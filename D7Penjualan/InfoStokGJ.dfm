object InfoStokGJFrm: TInfoStokGJFrm
  Left = 290
  Top = 133
  Width = 1028
  Height = 525
    ...
    object PanelBrowse: TPanel
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'READY'#9'12'#9'STOK~AKHIR'#9'F'
          'SATUAN'#9'6'#9'SAT'#9'F'
          'QTY_KEMASAN'#9'7'#9'BOX'#9'F'#9'KEMASAN'
  ...
  object QBrowse4: TOracleDataSet
    ...
    Variables.Data = {0300000001000000070000003A564F52444552010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      ...
      004A4E535F4B454D4153414E0100000000000B0000005154595F4B454D415341
      4E0100000000000C0000005154595F4B454D4153414E320100000000000C0000
      005154595F4B454D4153414E33010000000000}
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
    Filter = 'hasil_produksi>0'
    ...
    object QBrowse4QTY_KEMASAN: TFloatField
      FieldName = 'QTY_KEMASAN'
      DisplayFormat = '#.#,###;(#.#,###);-'
    end
    object QBrowse4QTY_KEMASAN2: TFloatField
      FieldName = 'QTY_KEMASAN2'
      DisplayFormat = '#.#,###;(#.#,###);-'
    end
    object QBrowse4QTY_KEMASAN3: TFloatField
      FieldName = 'QTY_KEMASAN3'
      DisplayFormat = '#.#,###;(#.#,###);-'
    end
    ...
    object QBrowse4JNS_KEMASAN: TStringField
      FieldName = 'JNS_KEMASAN'
    end
  end
