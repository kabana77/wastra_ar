...
var
  InfoStokGJ3Frm: TInfoStokGJ3Frm;
...
//  if InfoRealisasiPOFrm=Nil then
  begin
    InfoStokGJ3Frm:=TInfoStokGJ3Frm.Create(Application);
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;

    InfoStokGJ3Frm.vkode:=pkode+copy(pjudul,1,2);
    InfoStokGJ3Frm.vitem:=copy(pjudul,1,1);
    InfoStokGJ3Frm.Caption:=UpperCase(InfoStokGJ3Frm.PanelHeader.Caption);
    InfoStokGJ3Frm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    InfoStokGJ3Frm.wwDBGrid2.IniAttributes.SectionName:=InfoStokGJ3Frm.Caption+'2';
    InfoStokGJ3Frm.wwDBGrid2.IniAttributes.Enabled:=True;
    InfoStokGJ3Frm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,InfoStokGJ3Frm.Caption+'2',InfoStokGJ3Frm.wwDBGrid2);
    InfoStokGJ3Frm.wwDBSpinLine2.Value:=InfoStokGJ3Frm.wwDBGrid2.RowHeightPercent;
...
procedure TInfoStokGJ3Frm.FormClose(Sender: TObject;
...
procedure TInfoStokGJ3Frm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TInfoStokGJ3Frm.BtnExportClick(Sender: TObject);
begin
...
procedure TInfoStokGJ3Frm.BtnOkClick(Sender: TObject);
var
...
procedure TInfoStokGJ3Frm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
...
procedure TInfoStokGJ3Frm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TInfoStokGJ3Frm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TInfoStokGJ3Frm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TInfoStokGJ3Frm.BtnFindClick(Sender: TObject);
begin
if CheckBox2.Checked=false then
  begin
...
procedure TInfoStokGJ3Frm.BtnOk2Click(Sender: TObject);
begin
if CheckBox2.Checked=false then
begin
  if QBrowse.QBEMode then
...
procedure TInfoStokGJ3Frm.BtnPrintBrowseClick(Sender: TObject);
begin
...
procedure TInfoStokGJ3Frm.Label5Click(Sender: TObject);
begin
...
procedure TInfoStokGJ3Frm.LookItemEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TInfoStokGJ3Frm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TInfoStokGJ3Frm.FormShow(Sender: TObject);
begin
...
procedure TInfoStokGJ3Frm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if QBrowse.FieldByName(AFieldName).FieldKind=fkData then
  begin
...
procedure TInfoStokGJ3Frm.SpeedButton2Click(Sender: TObject);
begin
...
procedure TInfoStokGJ3Frm.SpeedButton1Click(Sender: TObject);
begin
  wwDBGrid2.BringToFront;
end;

procedure TInfoStokGJ3Frm.ppDetailBand1BeforePrint(Sender: TObject);
begin
  ppVariable1.AsInteger:=ppVariable1.AsInteger+1;
end;

procedure TInfoStokGJ3Frm.BitBtn1Click(Sender: TObject);
begin
  ppVariable1.AsInteger:=0;
  ppReport1.Print;
end;

procedure TInfoStokGJ3Frm.BitBtn2Click(Sender: TObject);
begin
...
procedure TInfoStokGJ3Frm.BitBtn3Click(Sender: TObject);
begin
...
procedure TInfoStokGJ3Frm.QBrowseCalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJ3Frm.QBrowse2CalcFields(DataSet: TDataSet);
begin
  QBrowse2READY2.AsFloat:=QBrowse2READY.AsFloat-QBrowse2SPB.AsFloat;
end;

procedure TInfoStokGJ3Frm.wwDBGrid2DblClick(Sender: TObject);
begin
...
procedure TInfoStokGJ3Frm.Button1Click(Sender: TObject);
begin
      if QBrowse.QBEMode then
      QBrowse.QBEMode:=False;
      QBrowse.DisableControls;
...
procedure TInfoStokGJ3Frm.BtnFilterClick(Sender: TObject);
var
  vt1, vt2, vt3, vt4, vt5, vt6, vt7,
  vt8, vt9, vt10, vt11, vt12, vt13, vt14,
  vt15, vt16 : real;
...
procedure TInfoStokGJ3Frm.SpeedButton3Click(Sender: TObject);
begin
...
procedure TInfoStokGJ3Frm.LookLokasiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TInfoStokGJ3Frm.LookLokasiEnter(Sender: TObject);
begin
QLokasi.Open;
end;

procedure TInfoStokGJ3Frm.QBrowse4AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse4.RecNo)+' dari '+FormatFloat('#,#',QBrowse4.RecordCount)+' Records';
end;

procedure TInfoStokGJ3Frm.QBrowse4CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJ3Frm.LookSubLokasiEnter(Sender: TObject);
begin
QSubLokasi.Open;
end;

procedure TInfoStokGJ3Frm.LookSubLokasiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
lblsub_lokasi.Caption:=QSubLokasiJNS_LOKASI.AsString;
end;

procedure TInfoStokGJ3Frm.QBrowse5AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse5.RecNo)+' dari '+FormatFloat('#,#',QBrowse5.RecordCount)+' Records';
end;

procedure TInfoStokGJ3Frm.QBrowse5CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJ3Frm.CheckBox3Click(Sender: TObject);
begin
if CheckBox3.Checked=True then
begin
Label7.Visible:=True;
