...
type
  TPermintaanDoublingFrm = class(TForm)
...
var
  PermintaanDoublingFrm: TPermintaanDoublingFrm;
...
//  if BPBFrm=Nil then
  begin
    PermintaanDoublingFrm:=TPermintaanDoublingFrm.Create(Application);
    PermintaanDoublingFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       PermintaanDoublingFrm.QMaster.ReadOnly:=True;
       PermintaanDoublingFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    PermintaanDoublingFrm.vkode:=copy(pjudul,1,3);;
    PermintaanDoublingFrm.vjns_lokasi:='';
    PermintaanDoublingFrm.vjns_brg:='';
    PermintaanDoublingFrm.QTransaksi.Open;

    PermintaanDoublingFrm.Caption:=UpperCase(pjudul);
    PermintaanDoublingFrm.PanelHeader.Caption:=PermintaanDoublingFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+PermintaanDoublingFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    PermintaanDoublingFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    PermintaanDoublingFrm.wwDBGrid1.IniAttributes.SectionName:=PermintaanDoublingFrm.Caption+'1';
    PermintaanDoublingFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    PermintaanDoublingFrm.wwDBGrid1.LoadFromIniFile;
    PermintaanDoublingFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    PermintaanDoublingFrm.wwDBGrid2.IniAttributes.SectionName:=PermintaanDoublingFrm.Caption+'2';
    PermintaanDoublingFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    PermintaanDoublingFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,PermintaanDoublingFrm.Caption+'1',PermintaanDoublingFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,PermintaanDoublingFrm.Caption+'2',PermintaanDoublingFrm.wwDBGrid2);
    PermintaanDoublingFrm.wwDBSpinLine1.Value:=PermintaanDoublingFrm.wwDBGrid1.RowHeightPercent;
    PermintaanDoublingFrm.wwDBSpinLine2.Value:=PermintaanDoublingFrm.wwDBGrid2.RowHeightPercent;

  end;

  PermintaanDoublingFrm.Show;
end;

procedure TPermintaanDoublingFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'1',wwDBGrid1);
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   PermintaanDoublingFrm:=Nil;
end;

procedure TPermintaanDoublingFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TPermintaanDoublingFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TPermintaanDoublingFrm.BtnOkClick(Sender: TObject);
begin
...
procedure TPermintaanDoublingFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TPermintaanDoublingFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TPermintaanDoublingFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TPermintaanDoublingFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TPermintaanDoublingFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TPermintaanDoublingFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TPermintaanDoublingFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TPermintaanDoublingFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TPermintaanDoublingFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TPermintaanDoublingFrm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TPermintaanDoublingFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TPermintaanDoublingFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TPermintaanDoublingFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TPermintaanDoublingFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TPermintaanDoublingFrm.TabSheet1Show(Sender: TObject);
begin
  vorder:='nama_kemasan';
...
procedure TPermintaanDoublingFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TPermintaanDoublingFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TPermintaanDoublingFrm.BtnPrintInputClick(Sender: TObject);
begin
  ppReportInput.Print;
end;

procedure TPermintaanDoublingFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TPermintaanDoublingFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TPermintaanDoublingFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TPermintaanDoublingFrm.Label5Click(Sender: TObject);
begin
...
procedure TPermintaanDoublingFrm.LookItemEnter(Sender: TObject);
begin
...
procedure TPermintaanDoublingFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TPermintaanDoublingFrm.QMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TPermintaanDoublingFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPermintaanDoublingFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TPermintaanDoublingFrm.FormCloseQuery(Sender: TObject;
...
procedure TPermintaanDoublingFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TPermintaanDoublingFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TPermintaanDoublingFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TPermintaanDoublingFrm.QProc_Update_POBeforeQuery(Sender: TOracleQuery);
begin
  QProc_Update_PO.SetVariable('NO_PO',QMasterNO_BUKTI.AsString);
end;

procedure TPermintaanDoublingFrm.QLokasiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPermintaanDoublingFrm.LookLokasiEnter(Sender: TObject);
begin
  QLokasi.Open;
end;

procedure TPermintaanDoublingFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
...
procedure TPermintaanDoublingFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
...
procedure TPermintaanDoublingFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TPermintaanDoublingFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TPermintaanDoublingFrm.FormShow(Sender: TObject);
begin
  PanelHeader.Caption:=QTransaksiKD_TRANSAKSI.AsString+'. '+UpperCase(Caption);
QItem.Close;
end;

procedure TPermintaanDoublingFrm.LookSuplierEnter(Sender: TObject);
begin
//  QCalonSuplier.Close;
...
procedure TPermintaanDoublingFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
//  vorder:='nama_corak';
  QItem.Close;
...
procedure TPermintaanDoublingFrm.LookItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  vorder:='nama_kemasan';
  QItem.Close;
...
procedure TPermintaanDoublingFrm.TabSheet2Show(Sender: TObject);
begin
  vorder:='';
end;

procedure TPermintaanDoublingFrm.ppNo2Calc(Sender: TObject;
  var Value: Variant);
begin
  Value:=Value+1;
end;

procedure TPermintaanDoublingFrm.BitBtn1Click(Sender: TObject);
begin
...
procedure TPermintaanDoublingFrm.LookLokasiCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QDetailKDSUBLOKASI_GJ.asstring:=LookLokasi.Text;
end;

procedure TPermintaanDoublingFrm.LookSPEnter(Sender: TObject);
begin
QSP.close;
QSP.Open;
end;

procedure TPermintaanDoublingFrm.LookSPCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
...
procedure TPermintaanDoublingFrm.wwDBComboBox1CloseUp(
  Sender: TwwDBComboBox; Select: Boolean);
begin
QMasterJNS_ORDER.AsString:=wwDBComboBox1.Text;
end;

procedure TPermintaanDoublingFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
...
procedure TPermintaanDoublingFrm.LooksubLokasiEnter(Sender: TObject);
begin
QSubLokasi.close;
QSubLokasi.open;
end;

procedure TPermintaanDoublingFrm.LooksubLokasiCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 //  if modified then
...
procedure TPermintaanDoublingFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotalInput.Close;
...
procedure TPermintaanDoublingFrm.wwDBLookupComboDlg1CloseUp(
