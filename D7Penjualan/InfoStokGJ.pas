...
type
  TInfoStokGJFrm = class(TForm)
    ...
    QBrowse4QTY_KEMASAN: TFloatField;
    QBrowse4QTY_KEMASAN2: TFloatField;
    QBrowse4QTY_KEMASAN3: TFloatField;
    QBrowse4NO_LOT: TStringField;
    QBrowse4JNS_KEMASAN: TStringField;
...
//  if InfoRealisasiPOFrm=Nil then
  begin
    InfoStokGJFrm:=TInfoStokGJFrm.Create(Application);
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;

    InfoStokGJFrm.vkode:=pkode+copy(pjudul,1,2);
    InfoStokGJFrm.vitem:=copy(pjudul,1,1);
    InfoStokGJFrm.Caption:=UpperCase(InfoStokGJFrm.PanelHeader.Caption);
    InfoStokGJFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    InfoStokGJFrm.wwDBGrid2.IniAttributes.SectionName:=InfoStokGJFrm.Caption+'2';
    InfoStokGJFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    InfoStokGJFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,InfoStokGJFrm.Caption+'2',InfoStokGJFrm.wwDBGrid2);
    InfoStokGJFrm.wwDBSpinLine2.Value:=InfoStokGJFrm.wwDBGrid2.RowHeightPercent;
...
procedure TInfoStokGJFrm.FormClose(Sender: TObject;
...
procedure TInfoStokGJFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TInfoStokGJFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TInfoStokGJFrm.BtnOkClick(Sender: TObject);
var
...
procedure TInfoStokGJFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
...
procedure TInfoStokGJFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TInfoStokGJFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TInfoStokGJFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TInfoStokGJFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TInfoStokGJFrm.BtnOk2Click(Sender: TObject);
begin
if CheckBox2.Checked=false then
begin
  if QBrowse.QBEMode then
...
procedure TInfoStokGJFrm.BtnPrintBrowseClick(Sender: TObject);
begin
...
procedure TInfoStokGJFrm.Label5Click(Sender: TObject);
begin
...
procedure TInfoStokGJFrm.LookItemEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TInfoStokGJFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TInfoStokGJFrm.FormShow(Sender: TObject);
begin
...
procedure TInfoStokGJFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if QBrowse.FieldByName(AFieldName).FieldKind=fkData then
  begin
...
procedure TInfoStokGJFrm.SpeedButton2Click(Sender: TObject);
begin
...
procedure TInfoStokGJFrm.SpeedButton1Click(Sender: TObject);
begin
  wwDBGrid2.BringToFront;
end;

procedure TInfoStokGJFrm.ppDetailBand1BeforePrint(Sender: TObject);
begin
  ppVariable1.AsInteger:=ppVariable1.AsInteger+1;
end;

procedure TInfoStokGJFrm.BitBtn1Click(Sender: TObject);
begin
  ppVariable1.AsInteger:=0;
  ppReport1.Print;
end;

procedure TInfoStokGJFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TInfoStokGJFrm.BitBtn3Click(Sender: TObject);
begin
...
procedure TInfoStokGJFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJFrm.QBrowse2CalcFields(DataSet: TDataSet);
begin
  QBrowse2READY2.AsFloat:=QBrowse2READY.AsFloat-QBrowse2SPB.AsFloat;
end;

procedure TInfoStokGJFrm.wwDBGrid2DblClick(Sender: TObject);
begin
//IF CheckBox3.Checked=False then
 // begin
...
procedure TInfoStokGJFrm.Button1Click(Sender: TObject);
begin
      if QBrowse.QBEMode then
      QBrowse.QBEMode:=False;
      QBrowse.DisableControls;
...
procedure TInfoStokGJFrm.BtnFilterClick(Sender: TObject);
var
  vt1, vt2, vt3, vt4, vt5, vt6, vt7,
  vt8, vt9, vt10, vt11, vt12, vt13, vt14,
  vt15, vt16 : real;
...
procedure TInfoStokGJFrm.SpeedButton3Click(Sender: TObject);
begin
...
procedure TInfoStokGJFrm.LookLokasiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TInfoStokGJFrm.LookLokasiEnter(Sender: TObject);
begin
QLokasi.Open;
end;

procedure TInfoStokGJFrm.QBrowse4AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse4.RecNo)+' dari '+FormatFloat('#,#',QBrowse4.RecordCount)+' Records';
end;

procedure TInfoStokGJFrm.QBrowse4CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJFrm.LookSubLokasiEnter(Sender: TObject);
begin
QSubLokasi.Open;
end;

procedure TInfoStokGJFrm.LookSubLokasiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
lblsub_lokasi.Caption:=QSubLokasiJNS_LOKASI.AsString;
end;

procedure TInfoStokGJFrm.QBrowse5AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse5.RecNo)+' dari '+FormatFloat('#,#',QBrowse5.RecordCount)+' Records';
end;

procedure TInfoStokGJFrm.QBrowse5CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJFrm.CheckBox3Click(Sender: TObject);
begin
if CheckBox3.Checked=True then
begin
Label7.Visible:=True;
...
procedure TInfoStokGJFrm.wwDBGrid4DblClick(Sender: TObject);
begin
