object RencProdFrm: TRencProdFrm
  Left = 376
  Top = 324
  Width = 1072
  Height = 557
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet4: TTabSheet
        ...
        object wwDBGrid6: TwwDBGrid
          ...
          ControlType.Strings = (
            'STATUS;CheckBox;1;0'
            'NO_KONTRAK;CustomEdit;wwDBLookupComboDlg2;F'
            'POST;CheckBox;1;0')
          Selected.Strings = (
            'NO_KONTRAK'#9'22'#9'NO_KONTRAK'#9'F'#9
            'TGL_KONTRAK'#9'18'#9'TGL_KONTRAK'#9'T'#9
            'CUSTOMER'#9'30'#9'CUSTOMER'#9'T'#9
            'KD_ITEM'#9'8'#9'KD_ITEM'#9'T'#9
            'ITEM'#9'50'#9'ITEM'#9'T'#9
            'QTY'#9'10'#9'QTY'#9'T'#9
            'SAT'#9'10'#9'SAT'#9'T'#9
            'B00'#9'10'#9'Rencana Kirim~Bulan Ke 0'#9'F'#9
            'B01'#9'10'#9'Rencana Kirim~Bulan Ke 1'#9'F'#9
            'B02'#9'10'#9'Rencana Kirim~Bulan Ke 3'#9'F'#9
            'B03'#9'10'#9'Rencana Kirim~ >= Bulan Ke 3'#9'F')
          IniAttributes.Delimiter = ';;'
        ...
        object wwDBLookupComboDlg2: TwwDBLookupComboDlg
          ...
          Selected.Strings = (
            'NO_BUKTI'#9'22'#9'NO KONTRAK'#9'F'
            'TGL'#9'18'#9'TGL'#9'F'
            'KD_REKANAN'#9'10'#9'KD CUST'#9'F'
            'NAMA_REKANAN'#9'35'#9'CUSTOMER'#9'F'
            'KD_ITEM'#9'5'#9'KD_ITEM'#9'F'
            'NAMA_BARANG'#9'20'#9'NAMA_BARANG'#9'F'
  ...
  object QInvoice: TOracleDataSet
    SQL.Strings = (
      'select t.*,t.rowid from ipisma_db2.delivery_plans t :myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000003800000077686572
      652074676C5F6B6F6E7472616B203E3D207379736461746520616E642074676C
      5F6B6F6E7472616B203C3D20737973646174650000000000}
    QBEDefinition.QBEFieldDefs = {
      
      4154010000000000}
    Cursor = crSQLWait
    QueryAllRecords = False
    ...
    Left = 148
    Top = 240
    object QInvoiceNO_KONTRAK: TStringField
      DisplayWidth = 22
      FieldName = 'NO_KONTRAK'
      Size = 22
    end
    object QInvoiceTGL_KONTRAK: TDateTimeField
      DisplayWidth = 18
      FieldName = 'TGL_KONTRAK'
      DisplayFormat = 'dd mmm yyyy'
    end
    object QInvoiceCUSTOMER: TStringField
      DisplayWidth = 30
      FieldName = 'CUSTOMER'
      Size = 50
    end
    object QInvoiceKD_ITEM: TStringField
      DisplayWidth = 8
      FieldName = 'KD_ITEM'
      Size = 50
    end
    object QInvoiceITEM: TStringField
      DisplayWidth = 50
      FieldName = 'ITEM'
      Size = 50
    end
    object QInvoiceQTY: TFloatField
      DisplayWidth = 10
      FieldName = 'QTY'
      DisplayFormat = '#,##0.###;(#,##0.###)'
    end
    object QInvoiceSAT: TStringField
      DisplayWidth = 10
      FieldName = 'SAT'
      Size = 10
    end
    object QInvoiceB00: TFloatField
      DisplayLabel = 'Rencana Kirim~Bulan Ke 0'
      DisplayWidth = 10
      FieldName = 'B00'
      DisplayFormat = '#,##0.###;(#,##0.###)'
    end
    object QInvoiceB01: TFloatField
      DisplayLabel = 'Rencana Kirim~Bulan Ke 1'
      DisplayWidth = 10
      FieldName = 'B01'
      DisplayFormat = '#,##0.###;(#,##0.###)'
    end
    object QInvoiceB02: TFloatField
      DisplayLabel = 'Rencana Kirim~Bulan Ke 3'
      DisplayWidth = 10
      FieldName = 'B02'
      DisplayFormat = '#,##0.###;(#,##0.###)'
    end
    object QInvoiceB03: TFloatField
      DisplayLabel = 'Rencana Kirim~ >= Bulan Ke 3'
      DisplayWidth = 10
      FieldName = 'B03'
      DisplayFormat = '#,##0.###;(#,##0.###)'
    end
    object QInvoiceID_CUSTOMER: TFloatField
      DisplayWidth = 10
      FieldName = 'ID_CUSTOMER'
      Visible = False
    end
    object QInvoiceNO_NOTA: TStringField
      DisplayWidth = 16
      FieldName = 'NO_NOTA'
      Visible = False
      Size = 16
    end
    object QInvoiceID: TFloatField
      DisplayWidth = 10
      FieldName = 'ID'
      Visible = False
    end
    object QInvoiceB04: TFloatField
      DisplayWidth = 10
      FieldName = 'B04'
      Visible = False
      DisplayFormat = '#,##0.###;(#,##0.###)'
    end
    object QInvoiceB05: TFloatField
      DisplayWidth = 10
      FieldName = 'B05'
      Visible = False
      DisplayFormat = '#,##0.###;(#,##0.###)'
    end
    object QInvoiceTHN_KONTRAK: TStringField
      DisplayWidth = 2
      FieldName = 'THN_KONTRAK'
      Visible = False
      Size = 2
    end
    object QInvoiceIBUKTI_DETAIL: TFloatField
      DisplayWidth = 10
      FieldName = 'IBUKTI_DETAIL'
      Visible = False
    end
  ...
  object QKontrak: TOracleDataSet
    SQL.Strings = (
        ...
        'select a.no_nota, a.no_bukti, a.kd_rekanan, b.nama_rekanan, c.kd' +
        '_item, c.keterangan as nama_barang, c.keterangan_d as keterangan' +
        ', trunc(a.tgl) as tgl, to_char(a.tgl, '#39'YYYY'#39') as tahun, c.ibukti' +
        '_detail'
      
        ', c.qty7 as qty, '#39'BALLE'#39' as sat from ipisma_db2.bukti a, ipisma_' +
        'db1.rekanan b, ipisma_db2.bukti_detail c'
      'where'
      'a.ibukti = c.ibukti and'
      'a.kd_rekanan = b.kd_rekanan and'
      'a.status = '#39'OPEN'#39' and'
      'a.kd_transaksi = '#39'985'#39' and'
      'a.ispost = 1 and'
      'to_char(a.tgl, '#39'YYYY'#39') = '#39'2020'#39
      'order by a.tgl desc'
      ''
      ''
      '/*'
      ...
      '*/')
    QBEDefinition.QBEFieldDefs = {
      
      00000300000051545901000000000003000000534154010000000000}
    Session = DMFrm.OS
    Left = 232
    Top = 376
    ...
    object QKontrakNAMA_REKANAN: TStringField
      FieldName = 'NAMA_REKANAN'
      Size = 50
    end
    object QKontrakKD_ITEM: TStringField
      FieldName = 'KD_ITEM'
      Size = 50
    end
    object QKontrakNAMA_BARANG: TStringField
      FieldName = 'NAMA_BARANG'
      Size = 255
    end
    object QKontrakKETERANGAN: TStringField
      FieldName = 'KETERANGAN'
      Size = 255
    end
    ...
    object QKontrakTAHUN: TStringField
      FieldName = 'TAHUN'
      Size = 4
    end
    ...
    object QKontrakIBUKTI_DETAIL: TFloatField
      FieldName = 'IBUKTI_DETAIL'
      Required = True
    end
    object QKontrakQTY: TFloatField
      FieldName = 'QTY'
      DisplayFormat = '#,##0.###;(#,##0.###)'
    end
    object QKontrakSAT: TStringField
      FieldName = 'SAT'
      Size = 5
    end
  end
