object InfoStokGJHPPFrm: TInfoStokGJHPPFrm
  Left = 240
  Top = 198
  Width = 1067
  Height = 505
  ...
  object wwDBGrid3: TwwDBGrid
    ...
    ControlType.Strings = (
      'ISFIXED;CheckBox;1;0')
    Selected.Strings = (
      'NAMA_ITEM2'#9'15'#9'NAMA_ITEM2'#9'F'
      'KD_ITEM'#9'10'#9'KODE'#9'F'#9'ITEM'
      'NAMA_ITEM'#9'15'#9'NAMA'#9'F'#9'ITEM'
      'NO_LOT'#9'20'#9'NO LOT'#9'F'
      'AWAL'#9'8'#9'AWAL'#9'F'#9'SALDO'
      'NILAI1'#9'15'#9'NILAI'#9'F'#9'SALDO'
      'HASIL_PRODUKSI'#9'8'#9'PROD'#9'F'#9'PEMASUKAN'
      'NILAI2'#9'15'#9'NILAI'#9'F'#9'PEMASUKAN'
      'HASIL_PACKING'#9'8'#9'PACK'#9'F'#9'PEMASUKAN'
      'NILAI3'#9'15'#9'NILAI'#9'F'#9'PEMASUKAN'
      'QTY_KEMASAN'#9'8'#9'REPRO'#9'F'#9'PEMASUKAN'
      'NILAI7'#9'15'#9'NILAI'#9'F'#9'PEMASUKAN'
      'RETUR'#9'8'#9'RETUR'#9'F'#9'PEMASUKAN'
      'NILAI5'#9'15'#9'NILAI'#9'F'#9'PEMASUKAN'
      'ORDER_MKT'#9'8'#9'JUAL'#9'F'#9'PENGELUARAN'
      'NILAI6'#9'15'#9'NILAI'#9'F'#9'PENGELUARAN'
      'UNTUK_DIPACKING'#9'8'#9'REPACK'#9'F'#9'PENGELUARAN'
      'NILAI4'#9'15'#9'NILAI'#9'F'#9'PENGELUARAN'
      'QTY_KEMASAN2'#9'8'#9'REPRO'#9'F'#9'PENGELUARAN'
      'NILAI8'#9'15'#9'NILAI'#9'F'#9'PENGELUARAN'
      'ORDER_NON'#9'8'#9'SAMPLE'#9'F'
      'NILAI9'#9'15'#9'NILAI'#9'F'
      'RUSAK'#9'8'#9'KOREKSI'#9'F'
      'NILAI10'#9'15'#9'NILAI'#9'F'
      'READY'#9'8'#9'AKHIR'#9'F'#9'SALDO'
      'NILAI11'#9'15'#9'NILAI'#9'F'#9'SALDO')
    IniAttributes.Enabled = True
    IniAttributes.Delimiter = ';;'
    IniAttributes.CheckNewFields = True
  ...
  object QDump: TOracleQuery
    SQL.Strings = (
      'begin'
        ...
        'kasi,:zlokasi1,:zlokasi2,:tgl);'
      'end;'
      '')
    Session = DMFrm.OS
    Variables.Data = {
      03000000070000000A0000003A5653595344415445310C000000070000007872
      ...
      000000040000003A54474C0C0000000000000000000000090000003A5A4C4F4B
      41534931050000000000000000000000090000003A5A4C4F4B41534932050000
      000000000000000000}
    Left = 136
    Top = 280
  end
  ...
  object QDump31: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db2.proc_mutasi_HPP_REKAP;'
      'end;')
    Session = DMFrm.OS
    Left = 200
    Top = 336
