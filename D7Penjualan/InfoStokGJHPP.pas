...
var
  InfoStokGJHPPFrm: TInfoStokGJHPPFrm;
...
//  if InfoRealisasiPOFrm=Nil then
  begin
    InfoStokGJHPPFrm:=TInfoStokGJHPPFrm.Create(Application);
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;

    InfoStokGJHPPFrm.vkode:=pkode+copy(pjudul,1,2);
    InfoStokGJHPPFrm.vitem:=copy(pjudul,1,1);
    InfoStokGJHPPFrm.Caption:=UpperCase(InfoStokGJHPPFrm.PanelHeader.Caption);
    InfoStokGJHPPFrm.wwDBGrid3.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    InfoStokGJHPPFrm.wwDBGrid3.IniAttributes.SectionName:=InfoStokGJHPPFrm.Caption+'2';
    InfoStokGJHPPFrm.wwDBGrid3.IniAttributes.Enabled:=True;
    InfoStokGJHPPFrm.wwDBGrid3.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,InfoStokGJHPPFrm.Caption+'2',InfoStokGJHPPFrm.wwDBGrid3);
    InfoStokGJHPPFrm.wwDBSpinLine2.Value:=InfoStokGJHPPFrm.wwDBGrid3.RowHeightPercent;

  end;

  InfoStokGJHPPFrm.Show;
end;

procedure TInfoStokGJHPPFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid3);
   Action:=caFree;
   InfoStokGJHPPFrm:=Nil;
end;

procedure TInfoStokGJHPPFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TInfoStokGJHPPFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TInfoStokGJHPPFrm.BtnOkClick(Sender: TObject);
var
...
//  vwhere : string;
  ...
  if vTglAwal.Date>vTglAkhir.DateTime then
    ...
    begin
      ...
      QDump.SetVariable('zlokasi','1');
      QDump.SetVariable('zlokasi1','2');
      QDump.SetVariable('zlokasi2','4');
      QDump.SetVariable('vlokasi',QLokasiKD_LOKASI.AsString);
      QDump.SetVariable('tgl',Tgl1.Date);
      QDump.Execute;
      ...
      vt15:=0; vt16:=0;
          i:=0;
      LMDProgress1.Max:=QBrowse31.RecordCount;
      LMDProgress1.Position:=i;
      while not QBrowse31.Eof do
      begin
        inc(i);
        LMDProgress1.Position:=i;
        vt1:=vt1+QBrowse31AWAL.AsFloat;
        vt2:=vt2+QBrowse31HASIL_PRODUKSI.AsFloat;
        vt3:=vt3+QBrowse31HASIL_PACKING.AsFloat;
        vt4:=vt4+QBrowse31RETUR.AsFloat;
        vt5:=vt5+QBrowse31UNTUK_DIPACKING.AsFloat;
        vt6:=vt6+QBrowse31ORDER_MKT.AsFloat;
        vt7:=vt7+QBrowse31ORDER_NON.AsFloat;
       { vt8:=vt8+QBrowseKELUAR3.AsFloat;
        ...
        vt12:=vt12+QBrowse31READY.AsFloat;
        vt13:=vt13+QBrowse31QTY_KEMASAN.AsFloat;
        vt14:=vt14+QBrowse31QTY_KEMASAN2.AsFloat;
        vt15:=vt15+QBrowse31QTY_KEMASAN3.AsFloat;
...
procedure TInfoStokGJHPPFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
...
procedure TInfoStokGJHPPFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TInfoStokGJHPPFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TInfoStokGJHPPFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid3.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TInfoStokGJHPPFrm.BtnFindClick(Sender: TObject);
begin
if CheckBox2.Checked=false then
  begin
...
procedure TInfoStokGJHPPFrm.BtnOk2Click(Sender: TObject);
begin
if CheckBox2.Checked=false then
begin
...
procedure TInfoStokGJHPPFrm.BtnPrintBrowseClick(Sender: TObject);
begin
...
procedure TInfoStokGJHPPFrm.Label5Click(Sender: TObject);
begin
...
procedure TInfoStokGJHPPFrm.LookItemEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TInfoStokGJHPPFrm.vTglAwalChange(Sender: TObject);
begin
...
begin
  ...
  tgl1.Date:=StartOfTheMonth(StartOfTheMonth(vTglAwal.Date)-1)
 // VTglAkhir2.DateTime:=vTglAwal.Date-1;
end;

procedure TInfoStokGJHPPFrm.FormShow(Sender: TObject);
begin
...
procedure TInfoStokGJHPPFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TInfoStokGJHPPFrm.SpeedButton2Click(Sender: TObject);
begin
...
procedure TInfoStokGJHPPFrm.SpeedButton1Click(Sender: TObject);
begin
  wwDBGrid3.BringToFront;
end;

procedure TInfoStokGJHPPFrm.ppDetailBand1BeforePrint(Sender: TObject);
begin
  ppVariable1.AsInteger:=ppVariable1.AsInteger+1;
end;

procedure TInfoStokGJHPPFrm.BitBtn1Click(Sender: TObject);
begin
...
procedure TInfoStokGJHPPFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TInfoStokGJHPPFrm.BitBtn3Click(Sender: TObject);
begin
...
procedure TInfoStokGJHPPFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJHPPFrm.QBrowse2CalcFields(DataSet: TDataSet);
begin
  QBrowse2READY2.AsFloat:=QBrowse2READY.AsFloat-QBrowse2SPB.AsFloat;
end;

procedure TInfoStokGJHPPFrm.wwDBGrid2DblClick(Sender: TObject);
begin
{IF CheckBox3.Checked=False then
  begin
...
procedure TInfoStokGJHPPFrm.Button1Click(Sender: TObject);
begin
      if QBrowse.QBEMode then
      QBrowse.QBEMode:=False;
      QBrowse.DisableControls;
...
procedure TInfoStokGJHPPFrm.BtnFilterClick(Sender: TObject);
var
  vt1, vt2, vt3, vt4, vt5, vt6, vt7,
  vt8, vt9, vt10, vt11, vt12, vt13, vt14,
  vt15, vt16 : real;
...
procedure TInfoStokGJHPPFrm.SpeedButton3Click(Sender: TObject);
begin
...
procedure TInfoStokGJHPPFrm.LookLokasiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TInfoStokGJHPPFrm.LookLokasiEnter(Sender: TObject);
begin
QLokasi.Open;
end;

procedure TInfoStokGJHPPFrm.QBrowse4AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse4.RecNo)+' dari '+FormatFloat('#,#',QBrowse4.RecordCount)+' Records';
end;

procedure TInfoStokGJHPPFrm.QBrowse4CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJHPPFrm.LookSubLokasiEnter(Sender: TObject);
begin
QSubLokasi.Open;
end;

procedure TInfoStokGJHPPFrm.LookSubLokasiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
lblsub_lokasi.Caption:=QSubLokasiJNS_LOKASI.AsString;
end;

procedure TInfoStokGJHPPFrm.QBrowse5AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse5.RecNo)+' dari '+FormatFloat('#,#',QBrowse5.RecordCount)+' Records';
end;

procedure TInfoStokGJHPPFrm.QBrowse5CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJHPPFrm.CheckBox3Click(Sender: TObject);
begin
...
procedure TInfoStokGJHPPFrm.BitBtn4Click(Sender: TObject);
begin
{QDump11.Close;
...
procedure TInfoStokGJHPPFrm.VTglAkhir2Change(Sender: TObject);
begin
VTglAwal1.DateTime:=StartOfTheMonth(VTglAkhir2.Date);
VTglAwal2.DateTime:=VTglAkhir2.Date;
end;

procedure TInfoStokGJHPPFrm.QBrowse11AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse11.RecNo)+' dari '+FormatFloat('#,#',QBrowse11.RecordCount)+' Records';
end;

procedure TInfoStokGJHPPFrm.QBrowse11BeforeOpen(DataSet: TDataSet);
begin
...
procedure TInfoStokGJHPPFrm.wwDBGrid3DblClick(Sender: TObject);
begin
...
procedure TInfoStokGJHPPFrm.ppReport3BeforePrint(Sender: TObject);
begin
  ppLabel50.Caption:=LookLokasi.Text;
  ppLabel52.Caption:=vTglBulan.Text
end;

procedure TInfoStokGJHPPFrm.TGL1Change(Sender: TObject);
begin
tgl2.DateTime:=tgl1.Date - 1;
end;

procedure TInfoStokGJHPPFrm.TGL2Change(Sender: TObject);
begin
  tgl3.DateTime:=StartOfTheMonth(tgl2.Date);
end;

procedure TInfoStokGJHPPFrm.ppVariable3Calc(Sender: TObject;
  var Value: Variant);
begin
  Value:=Value+1;
end;
