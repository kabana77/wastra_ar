...
type
  TSPBLainnyaFrm = class(TForm)
    ...
    QOMKODE: TFloatField;
    QMasterKD_TRANSAKSI2: TStringField;
    QMasterAMBIL_BRG: TStringField;
    QOMBackup: TOracleDataSet;
...
//  if BPBFrm=Nil then
  begin
    SPBLainnyaFrm:=TSPBLainnyaFrm.Create(Application);
    SPBLainnyaFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       SPBLainnyaFrm.QMaster.ReadOnly:=True;
       SPBLainnyaFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    SPBLainnyaFrm.Caption:=UpperCase(pjudul);
    SPBLainnyaFrm.vkode:=copy(pjudul,1,3);
    SPBLainnyaFrm.vjns_lokasi:='';
    SPBLainnyaFrm.vjns_brg:='';
    SPBLainnyaFrm.QTransaksi.Open;


    SPBLainnyaFrm.PanelHeader.Caption:=SPBLainnyaFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+SPBLainnyaFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    SPBLainnyaFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    SPBLainnyaFrm.wwDBGrid1.IniAttributes.SectionName:=SPBLainnyaFrm.Caption+'1';
    SPBLainnyaFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    SPBLainnyaFrm.wwDBGrid1.LoadFromIniFile;
    SPBLainnyaFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    SPBLainnyaFrm.wwDBGrid2.IniAttributes.SectionName:=SPBLainnyaFrm.Caption+'2';
    SPBLainnyaFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    SPBLainnyaFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,SPBLainnyaFrm.Caption+'1',SPBLainnyaFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,SPBLainnyaFrm.Caption+'2',SPBLainnyaFrm.wwDBGrid2);
    SPBLainnyaFrm.wwDBSpinLine1.Value:=SPBLainnyaFrm.wwDBGrid1.RowHeightPercent;
    SPBLainnyaFrm.wwDBSpinLine2.Value:=SPBLainnyaFrm.wwDBGrid2.RowHeightPercent;
...
procedure TSPBLainnyaFrm.FormClose(Sender: TObject;
...
procedure TSPBLainnyaFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TSPBLainnyaFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.BtnOkClick(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TSPBLainnyaFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TSPBLainnyaFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TSPBLainnyaFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TSPBLainnyaFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TSPBLainnyaFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TSPBLainnyaFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TSPBLainnyaFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=0;
end;

procedure TSPBLainnyaFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TSPBLainnyaFrm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TSPBLainnyaFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TSPBLainnyaFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TSPBLainnyaFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TSPBLainnyaFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TSPBLainnyaFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.BtnPrintInputClick(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.QMasterBeforePost(DataSet: TDataSet);
begin
QCekPPN.Close;
...
{  if QMasterNO_BUKTI.AsString='' then
  ...
  if QMasterTGL_KIRIM.AsString='' then
   ...
   begin
     ...
     DMFrm.FNoUrut2.SetVariable(3,'P'+QMasterKETERANGAN2.AsString);
...
procedure TSPBLainnyaFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TSPBLainnyaFrm.Label5Click(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.LookItemEnter(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TSPBLainnyaFrm.QMasterNewRecord(DataSet: TDataSet);
begin
  QCalonSuplier.Close;
...
procedure TSPBLainnyaFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TSPBLainnyaFrm.ppPageStyle1BeforePrint(Sender: TObject);
begin
//  ppNo2.AsInteger:=0;
end;

procedure TSPBLainnyaFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TSPBLainnyaFrm.FormCloseQuery(Sender: TObject;
...
procedure TSPBLainnyaFrm.QMasterAfterPost(DataSet: TDataSet);
begin
  PageControl1.Pages[1].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
  PageControl1.Pages[2].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
end;

procedure TSPBLainnyaFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TSPBLainnyaFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TSPBLainnyaFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailIBUKTI.AsInteger:=QMasterIBUKTI2.AsInteger;
end;

procedure TSPBLainnyaFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TSPBLainnyaFrm.BtnAmbilDataClick(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.ppFooterBand3BeforePrint(Sender: TObject);
begin
  DMFrm.QTime.Close;
  DMFrm.QTime.Open;
end;

procedure TSPBLainnyaFrm.LookSuplierEnter(Sender: TObject);
begin
 if DMFrm.QUserISREMOTE.AsString='1' then
     QCalonSuplier.Session:=DMFrm.OSLocal     else      QCalonSuplier.Session:=DMFrm.OS;  QCalonSuplier.Open;
end;

procedure TSPBLainnyaFrm.wwDBLookupComboDlg3Enter(Sender: TObject);
begin
  DMFrm.QEkspedisi.Open;
end;

procedure TSPBLainnyaFrm.LookOMCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TSPBLainnyaFrm.LookOMEnter(Sender: TObject);
begin
  if wwDBComboBox2.Text='SAMPLE' then
    begin
    QOM.Close;
    QOM.DeleteVariables;
    QOM.DeclareVariable('pkd_rekanan',otinteger);
    QOM.DeclareVariable('ptgl',otinteger);
    QOM.SQL.Text:='select a.*,b.nama_rekanan, b.kd_rekanan as kode from ipisma_db2.vterimasementarafrm a, '+
                  'ipisma_db2.vcustomer_order b where a.kd_transaksi=''791'' and a.kd_rekanan=b.kd_rekanan and '+
                  'a.kd_rekanan=:pkd_rekanan and a.tanggal>=trunc(sysdate-:ptgl) order by a.tanggal, a.no_nota';
    QOM.SetVariable('pkd_rekanan',QMasterKD_REKANAN.AsInteger);
    QOM.SetVariable('ptgl',Round(wwDbSpin.Value));
    QOM.Open;
  end;
  if wwDBComboBox2.Text='RETUR' then
    begin
    QOM.Close;
    QOM.DeleteVariables;
    QOM.DeclareVariable('pkd_rekanan',otinteger);
    QOM.DeclareVariable('ptgl',otinteger);
    QOM.SQL.Text:='select a.*,b.nama_rekanan, b.kd_rekanan as kode from ipisma_db2.vterimasementarafrm a, '+
                  'ipisma_db1.rekanan b where a.kd_transaksi=''784'' and a.kd_rekanan=b.kd_rekanan and '+
                  'a.kd_rekanan=:pkd_rekanan and a.tanggal>=trunc(sysdate-:ptgl) order by a.tanggal, a.no_nota';
    QOM.SetVariable('pkd_rekanan',QMasterKD_REKANAN.AsInteger);
    QOM.SetVariable('ptgl',Round(wwDbSpin.Value));
    QOM.Open;
...
procedure TSPBLainnyaFrm.QDetailCalcFields(DataSet: TDataSet);
begin
  QDetailSISA.AsFloat:=QDetailQTY5.AsFloat-QDetailQTY6.AsFloat;
end;

procedure TSPBLainnyaFrm.QOMBeforeOpen(DataSet: TDataSet);
begin
  {QOM.SetVariable('pkd_rekanan',QMasterKD_REKANAN.AsInteger);
  QOM.SetVariable('ptgl',Round(wwDbSpin.Value)); }
end;

procedure TSPBLainnyaFrm.CheckBox1Click(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.btnOK1Click(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.vTglAwal1Change(Sender: TObject);
begin
vTglAkhir1.DateTime:=EndOfTheMonth(vTglAwal1.Date);
end;

procedure TSPBLainnyaFrm.BtnFind1Click(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.BtnOK3Click(Sender: TObject);
begin
  if QSPB_Customer.QBEMode then
  begin
...
procedure TSPBLainnyaFrm.BtnExport1Click(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.BtncloseClick(Sender: TObject);
begin
close;
end;

procedure TSPBLainnyaFrm.BtnPrintInputNSClick(Sender: TObject);
begin
  ppNo3.AsInteger:=0;
    if RGKertas.ItemIndex=0 then
...
procedure TSPBLainnyaFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
QLokasiItem.Open;
end;

procedure TSPBLainnyaFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
...
procedure TSPBLainnyaFrm.Qitem4BeforeQuery(Sender: TOracleDataSet);
begin
...
procedure TSPBLainnyaFrm.QItem5BeforeQuery(Sender: TOracleDataSet);
begin
...
procedure TSPBLainnyaFrm.Qitem2BeforeQuery(Sender: TOracleDataSet);
begin
{qItem2.setvariable('rekanan',qMasterKD_REKANAN.AsString);
QItem2.setvariable('no_bukti', QmasterNO_BUKTI.AsString); }
end;

procedure TSPBLainnyaFrm.QItem3BeforeQuery(Sender: TOracleDataSet);
begin
...
procedure TSPBLainnyaFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
{QItem2.Close;
qItem2.open;}
  ...
  if wwDBComboBox2.Text='SAMPLE' then
    begin
    QItem2.Close;
    QItem2.DeleteVariables;
    QItem2.DeclareVariable('rekanan',otinteger);
    QItem2.DeclareVariable('no_bukti',otString);
    QItem2.SQL.Text:='select a.ibukti_detail, a.no_bukti, a.kd_item, a.keterangan, a.keterangan_d, a.hrg, a.disc, '+
                  'a.qty3, a.qty7, a.hrg2, a.qty8,qty9, c.satuan, a.kd_sub_lokasi, a.rasio, b.no_nota, '+
                  'a.kdsublokasi_gj, a.jns_kemasan from ipisma_db2.bukti_detail a, ipisma_db2.bukti b, '+
                  'ipisma_db2.vitem c where a.ibukti=b.ibukti and b.kd_rekanan=:rekanan and a.qty10=0 and '+
                  'b.kd_transaksi in (''985'',''986'',''987'') and a.kd_item=c.kd_item and '+
                  'b.no_nota in (select no_bukti from ipisma_db2.bukti where kd_transaksi=''791'' and '+
                  'no_nota=:no_bukti)';
    QItem2.setvariable('rekanan',qMasterKD_REKANAN.AsString);
    QItem2.setvariable('no_bukti', QmasterNO_BUKTI.AsString);
    QItem2.Open;
  ...
  if wwDBComboBox2.Text='RETUR' then
    ...
    QItem2.SQL.Text:='select a.ibukti_detail, a.no_bukti, a.kd_item, a.keterangan, a.keterangan_d, a.hrg, a.disc, '+
                     ...
                     'ipisma_db2.vitem c where a.ibukti=b.ibukti and b.kd_rekanan=:rekanan and a.qty10=0 and '+
                     'b.kd_transaksi in (''985'',''986'',''987'') and a.kd_item=c.kd_item and '+
                     'b.no_nota in (select no_bukti from ipisma_db2.bukti where kd_transaksi=''784'' and '+
                     'no_nota=:no_bukti)';
    QItem2.setvariable('rekanan',qMasterKD_REKANAN.AsString);
    QItem2.setvariable('no_bukti', QmasterNO_BUKTI.AsString);
    QItem2.Open;
...
procedure TSPBLainnyaFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TSPBLainnyaFrm.ppFooterBand4BeforePrint(Sender: TObject);
begin
  DMFrm.QTime.Close;
  DMFrm.QTime.Open;
...
procedure TSPBLainnyaFrm.ppDetailBand4BeforePrint(Sender: TObject);
begin
  ppNo1.AsInteger:=ppNo1.AsInteger+1;

end;

procedure TSPBLainnyaFrm.BitBtn1Click(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.SpeedButton1Click(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.SpeedButton2Click(Sender: TObject);
begin
...
procedure TSPBLainnyaFrm.wwDBDateTimePicker3Change(Sender: TObject);
begin
  wwdbDateTimePicker4.DateTime:=EndOfTheMonth(wwdbDateTimePicker3.Date);
end;

procedure TSPBLainnyaFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotalInput.Close;
...
procedure TSPBLainnyaFrm.wwDBComboBox2Change(Sender: TObject);
begin
if wwDBComboBox2.Text='SAMPLE' then
  begin
    QMasterKD_TRANSAKSI2.asString:='791';
    QMasterKETERANGAN2.AsString:='S';
  end;
if wwDBComboBox2.Text='RETUR' then
  begin
    QMasterKD_TRANSAKSI2.asString:='784';
    QMasterKETERANGAN2.AsString:='R';
  end;
end;
