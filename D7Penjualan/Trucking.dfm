object TruckingFrm: TTruckingFrm
  Left = 338
  Top = 138
  Width = 960
  Height = 600
  Caption = 'Master Trucking'
  Color = clBtnFace
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select t.*, t.rowid from ipisma_db1.port t'
      ':myparam')
    ReadBuffer = 10
    Variables.Data = {
    ...
    Left = 60
    Top = 177
    object QMasterKD_PORT: TFloatField
      FieldName = 'KD_PORT'
      Required = True
      DisplayFormat = '000'
    end
  ...
  object QMaster2: TOracleDataSet
    SQL.Strings = (
      'select t.*, t.rowid from IPISMA_DB1.trucking t'
      ':myparam')
    ReadBuffer = 10
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    SequenceField.Field = 'KD_TRUCK'
    SequenceField.Sequence = 'IPISMA_DB1.TRUCK'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      0400000004000000080000004B445F545255434B010000000000040000004E41
      4D41010000000000050000004841524741010000000000070000004953414B54
      4946010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    CachedUpdates = True
    ...
    Left = 108
    Top = 233
    object QMaster2KD_TRUCK: TFloatField
      FieldName = 'KD_TRUCK'
      Required = True
    end
    object QMaster2NAMA: TStringField
      FieldName = 'NAMA'
      Size = 50
    end
    object QMaster2HARGA: TFloatField
      FieldName = 'HARGA'
    end
    object QMaster2ISAKTIF: TStringField
      FieldName = 'ISAKTIF'
      Size = 1
    end
  end
