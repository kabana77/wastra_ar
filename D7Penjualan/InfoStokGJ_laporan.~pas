...
type
  TInfoStokGJ_laporanFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelMain: TPanel;
    PanelHeader: TPanel;
...
var
  InfoStokGJ_laporanFrm: TInfoStokGJ_laporanFrm;
...
//  if InfoRealisasiPOFrm=Nil then
  begin
    InfoStokGJ_laporanFrm:=TInfoStokGJ_laporanFrm.Create(Application);
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;

    InfoStokGJ_laporanFrm.vkode:=pkode+copy(pjudul,1,2);
    InfoStokGJ_laporanFrm.vitem:=copy(pjudul,1,1);
    InfoStokGJ_laporanFrm.Caption:=UpperCase(InfoStokGJ_laporanFrm.PanelHeader.Caption);
    InfoStokGJ_laporanFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    InfoStokGJ_laporanFrm.wwDBGrid2.IniAttributes.SectionName:=InfoStokGJ_laporanFrm.Caption+'2';
    InfoStokGJ_laporanFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    InfoStokGJ_laporanFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,InfoStokGJ_laporanFrm.Caption+'2',InfoStokGJ_laporanFrm.wwDBGrid2);
    InfoStokGJ_laporanFrm.wwDBSpinLine2.Value:=InfoStokGJ_laporanFrm.wwDBGrid2.RowHeightPercent;
...
procedure TInfoStokGJ_laporanFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   InfoStokGJ_laporanFrm:=Nil;
end;

procedure TInfoStokGJ_laporanFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TInfoStokGJ_laporanFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TInfoStokGJ_laporanFrm.BtnOkClick(Sender: TObject);
var
...
procedure TInfoStokGJ_laporanFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
...
procedure TInfoStokGJ_laporanFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TInfoStokGJ_laporanFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TInfoStokGJ_laporanFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TInfoStokGJ_laporanFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TInfoStokGJ_laporanFrm.BtnOk2Click(Sender: TObject);
begin
if CheckBox2.Checked=false then
begin
  if QBrowse.QBEMode then
...
procedure TInfoStokGJ_laporanFrm.BtnPrintBrowseClick(Sender: TObject);
begin
...
procedure TInfoStokGJ_laporanFrm.Label5Click(Sender: TObject);
begin
...
procedure TInfoStokGJ_laporanFrm.LookItemEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TInfoStokGJ_laporanFrm.vTglAwalChange(Sender: TObject);
begin
  //vTglAkhir.DateTime:=StartOfTheMonth(vTglAwal.Date);
end;

procedure TInfoStokGJ_laporanFrm.FormShow(Sender: TObject);
begin
...
procedure TInfoStokGJ_laporanFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if QBrowse.FieldByName(AFieldName).FieldKind=fkData then
  begin
...
procedure TInfoStokGJ_laporanFrm.SpeedButton2Click(Sender: TObject);
begin
...
procedure TInfoStokGJ_laporanFrm.SpeedButton1Click(Sender: TObject);
begin
  wwDBGrid2.BringToFront;
end;

procedure TInfoStokGJ_laporanFrm.ppDetailBand1BeforePrint(Sender: TObject);
begin
  ppVariable1.AsInteger:=ppVariable1.AsInteger+1;
end;

procedure TInfoStokGJ_laporanFrm.BitBtn1Click(Sender: TObject);
begin
  ppVariable1.AsInteger:=0;
  ppReport1.Print;
end;

procedure TInfoStokGJ_laporanFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TInfoStokGJ_laporanFrm.BitBtn3Click(Sender: TObject);
begin
...
procedure TInfoStokGJ_laporanFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJ_laporanFrm.QBrowse2CalcFields(DataSet: TDataSet);
begin
  QBrowse2READY2.AsFloat:=QBrowse2READY.AsFloat-QBrowse2SPB.AsFloat;
end;

procedure TInfoStokGJ_laporanFrm.wwDBGrid2DblClick(Sender: TObject);
begin
//IF CheckBox3.Checked=False then
 // begin
...
procedure TInfoStokGJ_laporanFrm.Button1Click(Sender: TObject);
begin
      if QBrowse.QBEMode then
      QBrowse.QBEMode:=False;
      QBrowse.DisableControls;
...
procedure TInfoStokGJ_laporanFrm.BtnFilterClick(Sender: TObject);
var
  vt1, vt2, vt3, vt4, vt5, vt6, vt7,
  vt8, vt9, vt10, vt11, vt12, vt13, vt14,
  vt15, vt16 : real;
...
procedure TInfoStokGJ_laporanFrm.SpeedButton3Click(Sender: TObject);
begin
...
procedure TInfoStokGJ_laporanFrm.LookLokasiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TInfoStokGJ_laporanFrm.LookLokasiEnter(Sender: TObject);
begin
QLokasi.Open;
end;

procedure TInfoStokGJ_laporanFrm.QBrowse4AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse4.RecNo)+' dari '+FormatFloat('#,#',QBrowse4.RecordCount)+' Records';
end;

procedure TInfoStokGJ_laporanFrm.QBrowse4CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJ_laporanFrm.LookSubLokasiEnter(Sender: TObject);
begin
QSubLokasi.Open;
end;

procedure TInfoStokGJ_laporanFrm.LookSubLokasiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
lblsub_lokasi.Caption:=QSubLokasiJNS_LOKASI.AsString;
end;

procedure TInfoStokGJ_laporanFrm.QBrowse5AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse5.RecNo)+' dari '+FormatFloat('#,#',QBrowse5.RecordCount)+' Records';
end;

procedure TInfoStokGJ_laporanFrm.QBrowse5CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJ_laporanFrm.CheckBox3Click(Sender: TObject);
begin
if CheckBox3.Checked=True then
begin
Label7.Visible:=True;
...
procedure TInfoStokGJ_laporanFrm.wwDBGrid4DblClick(Sender: TObject);
begin
...
procedure TInfoStokGJ_laporanFrm.vTglAkhirChange(Sender: TObject);
begin
  vTglAwal.DateTime:=StartOfTheMonth(vTglAkhir.Date);
end;

procedure TInfoStokGJ_laporanFrm.Button2Click(Sender: TObject);
begin
if CheckBox3.Checked=false then
  begin
