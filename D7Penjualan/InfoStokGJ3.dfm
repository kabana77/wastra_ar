object InfoStokGJ3Frm: TInfoStokGJ3Frm
  Left = 427
  Top = 132
  Width = 707
  Height = 525
    ...
    object PanelBrowse: TPanel
      ...
      object wwDBGrid5: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'NAMA_KONSTRUKSI'#9'25'#9'KONSTRUKSI'#9'F'
          'SATUAN'#9'6'#9'SAT'#9'F'
          'JNS_KEMASAN'#9'20'#9'JENIS~KEMASAN'#9'F'
          'ISFIXED'#9'6'#9'FIXED'#9'F'
          'AWAL'#9'12'#9'AWAL~BULAN'#9'F'
          'HASIL_PRODUKSI'#9'12'#9'HSL PROD'#9'F'#9'MASUK'
          'HASIL_PACKING'#9'12'#9'MUTASI'#9'F'#9'MASUK'
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'HASIL_PACKING'#9'12'#9'ORDER'#9'F'#9'MASUK'
          'REPRO'#9'10'#9'REPRO'#9'F'
          'RETUR'#9'12'#9'RETUR'#9'F'#9'MASUK'
  ...
  object QDump: TOracleQuery
    SQL.Strings = (
      'begin'
        ...
        '  ipisma_db2.proc_mutasi_gj_doubling(:VSYSDATE1,:VSYSDATE2,:VLOK' +
        'ASI);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
