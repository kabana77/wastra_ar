object PindahLokasi2_JualFrm: TPindahLokasi2_JualFrm
  Left = 287
  Top = 49
  Width = 1024
  Height = 637
  ...
  object QItem: TOracleDataSet
    SQL.Strings = (
        ...
        'select distinct b.nama_item, b.kd_item, e.keterangan_d,e.kd_satu' +
        'an, e.satuan, sum(b.qty_in-b.qty_out) as qty, e.cis as qty_order' +
        ','
      'e.qty9 as qty_perkiraan ,e.hrg2, e.hrg as hrg'
      'from ipisma_db2.bukti_detail e, ipisma_db2.vkartu_stok3 b'
      'where e.kd_item=b.kd_item and e.no_bukti=:no_bukti and'
      'b.tanggal<=:tgl'
      
        'group by e.keterangan_d,e.cis, e.qty9,e.hrg, e.hrg2,b.nama_item,' +
        ' b.kd_item,e.kd_satuan, e.satuan'
      '/*'
        ...
        'from ipisma_db2.bukti_detail e, ipisma_db2.item a, ipisma_db2.vk' +
        'artu_stok3 b, ipisma_db2.sub_lokasi c, ipisma_db2.satuan d, ipis' +
        'ma_db2.corak p'
      
        'where e.kd_item=a.kd_item and e.no_bukti=:no_bukti and a.kd_item' +
        '=b.kd_item'
      'and b.kd_sub_lokasi= c.kd_sub_lokasi  and'
      'a.kd_satuan=d.kd_satuan and a.kd_corak=p.kd_corak and '
      'b.tanggal<=:tgl'
      ...
      '*/')
    Variables.Data = {
      0300000002000000090000003A4E4F5F42554B54490500000010000000393839
      2D313830322D3150423030310000000000040000003A54474C0C000000070000
      007876031F01010100000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      5154595F4F524445520100000000000D0000005154595F5045524B495241414E
      0100000000000C0000004B45544552414E47414E5F4401000000000004000000
      4852473201000000000003000000485247010000000000}
    ReadOnly = True
    QueryAllRecords = False
  ...
  object QBukti: TOracleDataSet
    SQL.Strings = (
      ...
      'where kd_transaksi='#39'989'#39' and no_nota =:nota')
    Variables.Data = {
      0300000001000000050000003A4E4F544105000000100000003938392D313830
      322D3050423030310000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QCekBuktiSisa: TOracleDataSet
    ...
    Variables.Data = {
      0300000002000000050000003A4954454D050000000700000030333830303700
  ...
  object QSO: TOracleDataSet
    SQL.Strings = (
        ...
        '_kirim, nama_rekanan, ppn, MU from ipisma_db2.vso_bbfrm'
      ...
      'order by no_nota')
    Variables.Data = {
      0300000001000000080000003A5046494C544552050000000400000039383900
      00000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QCekPPN: TOracleDataSet
    SQL.Strings = (
      'select d.ispjk'
      'from ipisma_db2.vso_bbfrm d '
      'where d.no_nota=:no_nota ')
    Variables.Data = {
      0300000001000000080000003A4E4F5F4E4F544105000000100000003938392D
      313830322D3050423030310000000000}
  ...
  object QCekBuktiSisa2: TOracleDataSet
    SQL.Strings = (
        ...
        'd_item=:item ')
    Variables.Data = {
      0300000002000000050000003A4E4F544105000000100000003938352D313730
      362D3150303030320000000000050000003A4954454D05000000070000003031
      363032360000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QCekBuktiSisaK: TOracleDataSet
    SQL.Strings = (
        ...
        'select NVL(sum(a.qty2),0)as qty_sisa from ipisma_db2.bukti_detai' +
        'l a, ipisma_db2.bukti b'
      
        'where a.kd_item=:item and b.no_bukti=:nota and a.ibukti=b.ibukti' +
        ' and b.kd_transaksi='#39'791'#39' and b.ispost ='#39'1'#39' and a.keterangan_d=:' +
        'keterangan')
    Variables.Data = {
      0300000003000000050000003A4954454D050000000700000030333830313000
      00000000050000003A4E4F544105000000100000003938352D313731312D3150
      3030303600000000000B0000003A4B45544552414E47414E0500000000000000
      00000000}
    QBEDefinition.QBEFieldDefs = {0400000001000000080000005154595F53495341010000000000}
    Session = DMFrm.OS
    Left = 712
  ...
  object QCekBuktiSisaK2: TOracleDataSet
    ...
    Variables.Data = {
      0300000003000000050000003A4E4F544105000000100000003938352D313731
      312D3150303030360000000000050000003A4954454D05000000070000003033
      3830313000000000000B0000003A4B45544552414E47414E0500000005000000
      422E31320000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000360000000D0000004942554B54495F44455441494C01000000000006
      0000004942554B5449010000000000080000004E4F5F42554B54490100000000
