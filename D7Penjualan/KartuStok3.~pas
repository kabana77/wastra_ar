...
type
  ...
  private
    ...
    vorder, SelectedFont, vitem, vjns, vbrg, vlot, vsp : String;
    vnomer : integer;
    vawal, vin, vout : real;
  public
    { Public declarations }
...
var
  KartuStok3Frm: TKartuStok3Frm;

procedure ShowForm(pNamaMenu:String; pjns : String; pawal : real; pbrg : string; pno_lot : string; psp : string);

implementation

uses DM, Kriteria_Tanggal1, KartuStok2;
...
//  if KartuStokFrm=Nil then
  begin
    KartuStok3Frm:=TKartuStok3Frm.Create(Application);
    mychar:=pjns;
    Delete(mychar,Pos('&',mychar),1);
    pjns:=mychar;
    KartuStok3Frm.Caption:='Barang '+pjns;
    KartuStok3Frm.vbrg:=UpperCase(pjns);
    KartuStok3Frm.vitem:=pbrg;
    KartuStok3Frm.vlot:=pno_lot;
    KartuStok3Frm.vsp:=psp;
    KartuStok3Frm.EditCari.Text:=pbrg;
    KartuStok3Frm.Edit1.Text:=pno_lot;
    KartuStok3Frm.Edit2.Text:=psp;
    KartuStok3Frm.vjns:='';
    KartuStok3Frm.vawal:=pawal;
    KartuStok3Frm.TabSheet1Show(nil);
    KartuStok3Frm.PanelHeader.Caption:=UpperCase(pjns);
    KartuStok3Frm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KartuStok3Frm.wwDBGrid1.IniAttributes.SectionName:=KartuStok3Frm.Caption+'1';
    KartuStok3Frm.wwDBGrid1.IniAttributes.Enabled:=True;
    KartuStok3Frm.wwDBGrid1.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,KartuStok3Frm.Caption+'1',KartuStok3Frm.wwDBGrid1);
    KartuStok3Frm.wwDBSpinLine1.Value:=KartuStok3Frm.wwDBGrid1.RowHeightPercent;
  end;
  KartuStok3Frm.Show;
//  KartuStokFrm.Free;
end;

procedure TKartuStok3Frm.FormClose(Sender: TObject;
...
procedure TKartuStok3Frm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TKartuStok3Frm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TKartuStok3Frm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TKartuStok3Frm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
//  ppNo.AsInteger:=0;
end;

procedure TKartuStok3Frm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TKartuStok3Frm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.Report:=ppReportBrowse;
  ppDesigner1.ShowModal;
end;

procedure TKartuStok3Frm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TKartuStok3Frm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKartuStok3Frm.TabSheet1Show(Sender: TObject);
begin
//  EditCari.Text:=vitem;
  QMaster.Close;
...
procedure TKartuStok3Frm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TKartuStok3Frm.BtnPrintInputClick(Sender: TObject);
begin
QTotal.Close;
...
procedure TKartuStok3Frm.FormShow(Sender: TObject);
begin
  PanelHeader.Caption:=UpperCase(Caption)+' '+vbrg;
end;

procedure TKartuStok3Frm.BtnDesign1Click(Sender: TObject);
begin
  ppDesigner1.Report:=ppReportInput;
  ppDesigner1.ShowModal;
end;

procedure TKartuStok3Frm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  vnomer:=vnomer+1;
  ppNomer3.Caption:=IntToStr(vnomer);
end;

procedure TKartuStok3Frm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TKartuStok3Frm.Label14Click(Sender: TObject);
begin
...
procedure TKartuStok3Frm.BtnAmbilDataClick(Sender: TObject);
begin
      ...
      if Kriteria_Tanggal1_FRM.wwDBDateTimePicker1.Date>Kriteria_Tanggal1_FRM.wwDBDateTimePicker2.Date then
        ...
        begin
          ...
          QDetail.SQL.Text:='select a.*, b.jns_lokasi as jns_lokasi_1 from '+cUserTabel+'vkartu_stok a, ipisma_db2.sub_sub_lokasi b '+
            ' where a.kd_item=:kd_item and a.spinning=:sp and a.no_lot=:lot and a.sub_lokasi=b.kd_sub_lokasi and a.tgl>=:pawal and a.tgl<=:pakhir and a.jns_lokasi in (''READY'',''SEMENTARA'',''PEMAKAIAN'')';
...
procedure TKartuStok3Frm.ppDetailBand1BeforePrint(Sender: TObject);
var
v : real;
x : string;
begin
...
procedure TKartuStok3Frm.BitBtn1Click(Sender: TObject);
begin
