object HPPProduksiFrm: THPPProduksiFrm
  Left = 258
  Top = 125
  Width = 1072
  Height = 673
  ...
  object PanelMain: TPanel
    ...
    object PageControl1: TPageControl
        ...
        object PanelDetail: TPanel
          ...
          object LookItem: TwwDBLookupComboDlg
            ...
            Selected.Strings = (
              ...
              'NAMA_CORAK'#9'10'#9'BLENDED'#9'F'#9
              'NAMA_KONSTRUKSI'#9'15'#9'BENANG'#9'F'#9
      ...
      object TabSheet4: TTabSheet
        Caption = 'Persediaan Barang Jadi'
        ImageIndex = 3
        object PanelFilter2: TPanel
          Left = 0
          Top = 0
          Width = 1792
          Height = 88
      ...
      object TabSheet5: TTabSheet
        Caption = 'Persediaan BJ Per Lokasi'
        ImageIndex = 4
        ...
        object wwDBGrid10: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'AWAL'#9'10'#9'QTY'#9'F'#9'AWAL'
            'V_AWAL'#9'10'#9'HPP'#9'F'#9'AWAL'
            'val_awal'#9'10'#9'NILAI'#9'F'#9'AWAL'
            'HASIL_PRODUKSI'#9'10'#9'QTY'#9'F'#9'PRODUKSI MASUK'
            'V_HASIL_PRODUKSI'#9'10'#9'HPP'#9'F'#9'PRODUKSI MASUK'
            'val_hasil_produksi'#9'10'#9'NILAI'#9'F'#9'PRODUKSI MASUK'
            'HASIL_PACKING'#9'10'#9'QTY'#9'F'#9'REPACK MASUK'
            'V_HASIL_PACKING'#9'10'#9'HPP'#9'F'#9'REPACK MASUK'
            'val_hasil_packing'#9'10'#9'NILAI'#9'F'#9'REPACK MASUK'
            'REPRO'#9'10'#9'QTY'#9'F'#9'REPRO MASUK'
            'V_REPRO'#9'10'#9'HPP'#9'F'#9'REPRO MASUK'
            'val_repro'#9'10'#9'NILAI'#9'F'#9'REPRO MASUK'
            'RETUR'#9'10'#9'QTY'#9'F'#9'RETUR MASUK'
            'V_RETUR'#9'10'#9'HPP'#9'F'#9'RETUR MASUK'
            'val_retur'#9'10'#9'NILAI'#9'F'#9'RETUR MASUK'
            'ORDER_MKT'#9'10'#9'QTY'#9'F'#9'PENJUALAN'
            'V_ORDER_MKT'#9'10'#9'HPP'#9'F'#9'PENJUALAN'
            'val_order_mkt'#9'10'#9'NILAI'#9'F'#9'PENJUALAN'
            'P_REPRO'#9'10'#9'QTY'#9'F'#9'REPRO KELUAR'
            'V_P_REPRO'#9'10'#9'HPP'#9'F'#9'REPRO KELUAR'
            'val_p_repro'#9'10'#9'NILAI'#9'F'#9'REPRO KELUAR'
            'UNTUK_DIPACKING'#9'10'#9'QTY'#9'F'#9'REPACK KELUAR'
            'V_UNTUK_DIPACKING'#9'10'#9'HPP'#9'F'#9'REPACK KELUAR'
            'val_untuk_dipacking'#9'10'#9'NILAI'#9'F'#9'REPACK KELUAR'
            'ORDER_NON'#9'10'#9'QTY'#9'F'#9'SAMPLE KELUAR'
            'V_ORDER_NON'#9'10'#9'HPP'#9'F'#9'SAMPLE KELUAR'
            'val_order_non'#9'10'#9'NILAI'#9'F'#9'SAMPLE KELUAR'
            'RUSAK'#9'10'#9'QTY'#9'F'#9'KOREKSI'
            'V_RUSAK'#9'10'#9'HPP'#9'F'#9'KOREKSI'
            'val_rusak'#9'10'#9'NILAI'#9'F'#9'KOREKSI'
            'READY'#9'10'#9'QTY'#9'F'#9'AKHIR'
            'V_READY'#9'10'#9'HPP'#9'F'#9'AKHIR'
            'val_ready'#9'10'#9'NILAI'#9'F'#9'AKHIR')
          IniAttributes.Enabled = True
          IniAttributes.Delimiter = ';;'
          IniAttributes.CheckNewFields = True
          ExportOptions.ExportType = wwgetSYLK
        ...
        object Panel1: TPanel
          ...
          object GroupBox2: TGroupBox
            ...
            object LookSpining: TwwDBLookupComboDlg
              Left = 64
              Top = 73
              Width = 57
              Height = 22
              ...
              Selected.Strings = (
                ...
                'NM_LOKASI'#9'30'#9'NM_LOKASI'#9'F')
              DataField = 'KD_SUB_LOKASI'
              LookupTable = QSpining
              ...
              ShowButton = True
              AllowClearKey = False
              OnCloseUp = LookSpiningCloseUp
              OnEnter = LookSpiningEnter
            end
          end
  ...
  object QLot: TOracleDataSet
    SQL.Strings = (
      'select b.no_lot as lot_number, '#39'1'#39' as isaktif, b.kd_item'
      'from'
      
        '(select distinct kd_item, no_lot from ipisma_db2.bukti_detail wh' +
        'ere no_lot is not null) b'
      'where b.kd_item = :vkd_item'
      ''
      ''
      ''
      
        '/*select a.* from ipisma_db2.lot_number a WHERE isaktif= 1 order' +
        ' by lot_number*/')
    Variables.Data = {
      0300000001000000090000003A564B445F4954454D0500000000000000000000
      00}
    QBEDefinition.QBEFieldDefs = {
      04000000030000000A0000004C4F545F4E554D42455201000000000007000000
      4953414B544946010000000000070000004B445F4954454D010000000000}
    RefreshOptions = [roAfterInsert]
    Session = DMFrm.OS
    Left = 32
    Top = 520
    ...
    object QLotKD_ITEM: TStringField
      FieldName = 'KD_ITEM'
      Size = 50
    end
  end
  ...
  object QBrowseValue: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db2.vstok_akhir2_hpp :vorder')
    ...
    Filtered = True
    OnCalcFields = QBrowseValueCalcFields
    OnFilterRecord = QBrowseValueFilterRecord
    Left = 700
    Top = 8
    object QBrowseValueKD_ITEM: TStringField
      FieldName = 'KD_ITEM'
      Size = 50
    end
    object QBrowseValueNAMA_ITEM: TStringField
      FieldName = 'NAMA_ITEM'
      Size = 101
    end
    object QBrowseValueNAMA_ITEM2: TStringField
      FieldName = 'NAMA_ITEM2'
      Size = 152
    end
    object QBrowseValueNAMA_KONSTRUKSI: TStringField
      FieldName = 'NAMA_KONSTRUKSI'
      Size = 50
    end
    object QBrowseValueNAMA_CORAK: TStringField
      FieldName = 'NAMA_CORAK'
      Size = 50
    end
    object QBrowseValueNAMA_KEMASAN: TStringField
      FieldName = 'NAMA_KEMASAN'
      Size = 50
    end
    object QBrowseValueSATUAN: TStringField
      FieldName = 'SATUAN'
      Size = 12
    end
    object QBrowseValueRASIO: TFloatField
      FieldName = 'RASIO'
    end
    object QBrowseValueTGL_INSERT: TDateTimeField
      FieldName = 'TGL_INSERT'
    end
    object QBrowseValueKD_KEMASAN: TStringField
      FieldName = 'KD_KEMASAN'
      Size = 50
    end
    object QBrowseValueKD_SATUAN: TStringField
      FieldName = 'KD_SATUAN'
      Size = 2
    end
    object QBrowseValueHRG_POKOK: TFloatField
      FieldName = 'HRG_POKOK'
    end
    object QBrowseValueHRG_JUAL: TFloatField
      FieldName = 'HRG_JUAL'
    end
    object QBrowseValueISFIXED: TStringField
      FieldName = 'ISFIXED'
      Size = 1
    end
    object QBrowseValueAWAL: TFloatField
      FieldName = 'AWAL'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueHASIL_PRODUKSI: TFloatField
      FieldName = 'HASIL_PRODUKSI'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueHASIL_PACKING: TFloatField
      FieldName = 'HASIL_PACKING'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueUNTUK_DIPACKING: TFloatField
      FieldName = 'UNTUK_DIPACKING'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValuePP_MKT: TFloatField
      FieldName = 'PP_MKT'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueORDER_MKT: TFloatField
      FieldName = 'ORDER_MKT'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueORDER_KONS: TFloatField
      FieldName = 'ORDER_KONS'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueORDER_NON: TFloatField
      FieldName = 'ORDER_NON'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueRETUR: TFloatField
      FieldName = 'RETUR'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueRUSAK: TFloatField
      FieldName = 'RUSAK'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueREADY: TFloatField
      FieldName = 'READY'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueSPB: TFloatField
      FieldName = 'SPB'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueNO_LOT: TStringField
      FieldName = 'NO_LOT'
      Size = 25
    end
    object QBrowseValueJNS_KEMASAN: TStringField
      FieldName = 'JNS_KEMASAN'
      Size = 10
    end
    object QBrowseValueQTY_KEMASAN: TFloatField
      FieldName = 'QTY_KEMASAN'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueQTY_KEMASAN2: TFloatField
      FieldName = 'QTY_KEMASAN2'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueQTY_KEMASAN3: TFloatField
      FieldName = 'QTY_KEMASAN3'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueREADY2: TFloatField
      FieldKind = fkCalculated
      FieldName = 'READY2'
      DisplayFormat = '0.#,###;(0.#,###);-'
      Calculated = True
    end
    object QBrowseValueREADY2STOK: TFloatField
      FieldKind = fkCalculated
      FieldName = 'READY2STOK'
      DisplayFormat = '0.#,###;(0.#,###);-'
      Calculated = True
    end
    object QBrowseValueP_REPRO: TFloatField
      FieldName = 'P_REPRO'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueREPRO: TFloatField
      FieldName = 'REPRO'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueLReady: TFloatField
      FieldKind = fkCalculated
      FieldName = 'LReady'
      DisplayFormat = '0.#,###;(0.#,###);-'
      Calculated = True
    end
    object QBrowseValueREPRO_BOX: TFloatField
      FieldName = 'REPRO_BOX'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueREPRO_KRG: TFloatField
      FieldName = 'REPRO_KRG'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueREPRO_PLT: TFloatField
      FieldName = 'REPRO_PLT'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueP_REPRO_BOX: TFloatField
      FieldName = 'P_REPRO_BOX'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueP_REPRO_KRG: TFloatField
      FieldName = 'P_REPRO_KRG'
      DisplayFormat = '0.#,###;(0.#,###);-'
    end
    object QBrowseValueP_REPRO_PLT: TFloatField
  ...
  object QDump: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db2.proc_mutasi_hpp(:VSYSDATE1,:VSYSDATE2);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object dsQBrowseValue: TwwDataSource
    DataSet = QBrowseValue
    Left = 608
  end
  object QDump2: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db2.proc_mutasi_gj_hpp(:VSYSDATE1,:VSYSDATE2,:VLOKASI);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QBrowse2: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db2.vstok_akhir_gj_hpp'
      ':vorder'
      ''
      '')
    Variables.Data = {0300000001000000070000003A564F52444552010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000320000000F0000004E414D415F4B4F4E535452554B53490100000000
      ...
      
      0000}
    Session = DMFrm.OS
    ...
    object QBrowse2V_AWAL: TFloatField
      FieldName = 'V_AWAL'
      DisplayFormat = '#.#,##;(#.#,##);-'
    end
    object QBrowse2V_HASIL_PRODUKSI: TFloatField
      FieldName = 'V_HASIL_PRODUKSI'
      DisplayFormat = '#.#,##;(#.#,##);-'
    end
    object QBrowse2V_HASIL_PACKING: TFloatField
      FieldName = 'V_HASIL_PACKING'
      DisplayFormat = '#.#,##;(#.#,##);-'
    end
    object QBrowse2V_UNTUK_DIPACKING: TFloatField
      FieldName = 'V_UNTUK_DIPACKING'
      DisplayFormat = '#.#,##;(#.#,##);-'
    end
    object QBrowse2V_PP_MKT: TFloatField
      FieldName = 'V_PP_MKT'
      DisplayFormat = '#.#,##;(#.#,##);-'
    end
    object QBrowse2V_ORDER_MKT: TFloatField
      FieldName = 'V_ORDER_MKT'
      DisplayFormat = '#.#,##;(#.#,##);-'
    end
    object QBrowse2V_ORDER_KONS: TFloatField
      FieldName = 'V_ORDER_KONS'
      DisplayFormat = '#.#,##;(#.#,##);-'
    end
    object QBrowse2V_ORDER_NON: TFloatField
      FieldName = 'V_ORDER_NON'
      DisplayFormat = '#.#,##;(#.#,##);-'
    end
    object QBrowse2V_RETUR: TFloatField
      FieldName = 'V_RETUR'
      DisplayFormat = '#.#,##;(#.#,##);-'
    end
    object QBrowse2V_RUSAK: TFloatField
      FieldName = 'V_RUSAK'
      DisplayFormat = '#.#,##;(#.#,##);-'
    end
    object QBrowse2V_READY: TFloatField
      FieldName = 'V_READY'
      DisplayFormat = '#.#,##;(#.#,##);-'
    end
    object QBrowse2V_SPB: TFloatField
      FieldName = 'V_SPB'
      DisplayFormat = '#.#,##;(#.#,##);-'
    end
    object QBrowse2V_P_REPRO: TFloatField
      FieldName = 'V_P_REPRO'
      DisplayFormat = '#.#,##;(#.#,##);-'
    end
    object QBrowse2V_REPRO: TFloatField
      FieldName = 'V_REPRO'
      DisplayFormat = '#.#,##;(#.#,##);-'
    end
    object QBrowse2val_awal: TFloatField
      FieldKind = fkCalculated
      FieldName = 'val_awal'
      DisplayFormat = '#.#,##;(#.#,##);-'
      Calculated = True
    end
    object QBrowse2val_hasil_produksi: TFloatField
      FieldKind = fkCalculated
      FieldName = 'val_hasil_produksi'
      DisplayFormat = '#.#,##;(#.#,##);-'
      Calculated = True
    end
    object QBrowse2val_hasil_packing: TFloatField
      FieldKind = fkCalculated
      FieldName = 'val_hasil_packing'
      DisplayFormat = '#.#,##;(#.#,##);-'
      Calculated = True
    end
    object QBrowse2val_untuk_dipacking: TFloatField
      FieldKind = fkCalculated
      FieldName = 'val_untuk_dipacking'
      DisplayFormat = '#.#,##;(#.#,##);-'
      Calculated = True
    end
    object QBrowse2val_pp_mkt: TFloatField
      FieldKind = fkCalculated
      FieldName = 'val_pp_mkt'
      DisplayFormat = '#.#,##;(#.#,##);-'
      Calculated = True
    end
    object QBrowse2val_order_mkt: TFloatField
      FieldKind = fkCalculated
      FieldName = 'val_order_mkt'
      DisplayFormat = '#.#,##;(#.#,##);-'
      Calculated = True
    end
    object QBrowse2val_order_kons: TFloatField
      FieldKind = fkCalculated
      FieldName = 'val_order_kons'
      DisplayFormat = '#.#,##;(#.#,##);-'
      Calculated = True
    end
    object QBrowse2val_order_non: TFloatField
      FieldKind = fkCalculated
      FieldName = 'val_order_non'
      DisplayFormat = '#.#,##;(#.#,##);-'
      Calculated = True
    end
    object QBrowse2val_retur: TFloatField
      FieldKind = fkCalculated
      FieldName = 'val_retur'
      DisplayFormat = '#.#,##;(#.#,##);-'
      Calculated = True
    end
    object QBrowse2val_rusak: TFloatField
      FieldKind = fkCalculated
      FieldName = 'val_rusak'
      DisplayFormat = '#.#,##;(#.#,##);-'
      Calculated = True
    end
    object QBrowse2val_ready: TFloatField
      FieldKind = fkCalculated
      FieldName = 'val_ready'
      DisplayFormat = '#.#,##;(#.#,##);-'
      Calculated = True
    end
    object QBrowse2val_p_repro: TFloatField
      FieldKind = fkCalculated
      FieldName = 'val_p_repro'
      DisplayFormat = '#.#,##;(#.#,##);-'
      Calculated = True
    end
    object QBrowse2val_repro: TFloatField
      FieldKind = fkCalculated
      FieldName = 'val_repro'
      DisplayFormat = '#.#,##;(#.#,##);-'
      Calculated = True
  ...
  object QSpining: TOracleDataSet
    SQL.Strings = (
    ...
    Left = 784
    Top = 456
    object QSpiningKD_SUB_LOKASI: TStringField
      FieldName = 'KD_SUB_LOKASI'
      Required = True
      Size = 12
    end
    object QSpiningKD_LOKASI: TStringField
      FieldName = 'KD_LOKASI'
      Size = 6
    end
    object QSpiningJNS_LOKASI: TStringField
      FieldName = 'JNS_LOKASI'
      Required = True
      Size = 10
    end
    object QSpiningNM_LOKASI: TStringField
      FieldName = 'NM_LOKASI'
      Size = 100
    end
  end
