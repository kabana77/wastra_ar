...
type
  TInfoStokGJ3_laporanFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelMain: TPanel;
    PanelHeader: TPanel;
...
var
  InfoStokGJ3_laporanFrm: TInfoStokGJ3_laporanFrm;
...
//  if InfoRealisasiPOFrm=Nil then
  begin
    InfoStokGJ3_laporanFrm:=TInfoStokGJ3_laporanFrm.Create(Application);
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;

    InfoStokGJ3_laporanFrm.vkode:=pkode+copy(pjudul,1,2);
    InfoStokGJ3_laporanFrm.vitem:=copy(pjudul,1,1);
    InfoStokGJ3_laporanFrm.Caption:=UpperCase(InfoStokGJ3_laporanFrm.PanelHeader.Caption);
    InfoStokGJ3_laporanFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    InfoStokGJ3_laporanFrm.wwDBGrid2.IniAttributes.SectionName:=InfoStokGJ3_laporanFrm.Caption+'2';
    InfoStokGJ3_laporanFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    InfoStokGJ3_laporanFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,InfoStokGJ3_laporanFrm.Caption+'2',InfoStokGJ3_laporanFrm.wwDBGrid2);
    InfoStokGJ3_laporanFrm.wwDBSpinLine2.Value:=InfoStokGJ3_laporanFrm.wwDBGrid2.RowHeightPercent;

  end;

  InfoStokGJ3_laporanFrm.Show;
end;

procedure TInfoStokGJ3_laporanFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   InfoStokGJ3_laporanFrm:=Nil;
end;

procedure TInfoStokGJ3_laporanFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TInfoStokGJ3_laporanFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TInfoStokGJ3_laporanFrm.BtnOkClick(Sender: TObject);
var
...
procedure TInfoStokGJ3_laporanFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
var
...
procedure TInfoStokGJ3_laporanFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TInfoStokGJ3_laporanFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TInfoStokGJ3_laporanFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TInfoStokGJ3_laporanFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TInfoStokGJ3_laporanFrm.BtnOk2Click(Sender: TObject);
begin
if CheckBox2.Checked=false then
begin
  if QBrowse.QBEMode then
...
procedure TInfoStokGJ3_laporanFrm.BtnPrintBrowseClick(Sender: TObject);
begin
...
procedure TInfoStokGJ3_laporanFrm.Label5Click(Sender: TObject);
begin
...
procedure TInfoStokGJ3_laporanFrm.LookItemEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TInfoStokGJ3_laporanFrm.vTglAwalChange(Sender: TObject);
begin
  //vTglAkhir.DateTime:=StartOfTheMonth(vTglAwal.Date);
end;

procedure TInfoStokGJ3_laporanFrm.FormShow(Sender: TObject);
begin
...
procedure TInfoStokGJ3_laporanFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if QBrowse.FieldByName(AFieldName).FieldKind=fkData then
  begin
...
procedure TInfoStokGJ3_laporanFrm.SpeedButton2Click(Sender: TObject);
begin
...
procedure TInfoStokGJ3_laporanFrm.SpeedButton1Click(Sender: TObject);
begin
  wwDBGrid2.BringToFront;
end;

procedure TInfoStokGJ3_laporanFrm.ppDetailBand1BeforePrint(Sender: TObject);
begin
  ppVariable1.AsInteger:=ppVariable1.AsInteger+1;
end;

procedure TInfoStokGJ3_laporanFrm.BitBtn1Click(Sender: TObject);
begin
  ppVariable1.AsInteger:=0;
  ppReport1.Print;
end;

procedure TInfoStokGJ3_laporanFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TInfoStokGJ3_laporanFrm.BitBtn3Click(Sender: TObject);
begin
...
procedure TInfoStokGJ3_laporanFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJ3_laporanFrm.QBrowse2CalcFields(DataSet: TDataSet);
begin
  QBrowse2READY2.AsFloat:=QBrowse2READY.AsFloat-QBrowse2SPB.AsFloat;
end;

procedure TInfoStokGJ3_laporanFrm.wwDBGrid2DblClick(Sender: TObject);
begin
//IF CheckBox3.Checked=False then
 // begin
...
procedure TInfoStokGJ3_laporanFrm.Button1Click(Sender: TObject);
begin
      if QBrowse.QBEMode then
      QBrowse.QBEMode:=False;
      QBrowse.DisableControls;
...
procedure TInfoStokGJ3_laporanFrm.BtnFilterClick(Sender: TObject);
var
  vt1, vt2, vt3, vt4, vt5, vt6, vt7,
  vt8, vt9, vt10, vt11, vt12, vt13, vt14,
  vt15, vt16 : real;
...
procedure TInfoStokGJ3_laporanFrm.SpeedButton3Click(Sender: TObject);
begin
...
procedure TInfoStokGJ3_laporanFrm.LookLokasiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TInfoStokGJ3_laporanFrm.LookLokasiEnter(Sender: TObject);
begin
QLokasi.Open;
end;

procedure TInfoStokGJ3_laporanFrm.QBrowse4AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse4.RecNo)+' dari '+FormatFloat('#,#',QBrowse4.RecordCount)+' Records';
end;

procedure TInfoStokGJ3_laporanFrm.QBrowse4CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJ3_laporanFrm.LookSubLokasiEnter(Sender: TObject);
begin
QSubLokasi.Open;
end;

procedure TInfoStokGJ3_laporanFrm.LookSubLokasiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
lblsub_lokasi.Caption:=QSubLokasiJNS_LOKASI.AsString;
end;

procedure TInfoStokGJ3_laporanFrm.QBrowse5AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse5.RecNo)+' dari '+FormatFloat('#,#',QBrowse5.RecordCount)+' Records';
end;

procedure TInfoStokGJ3_laporanFrm.QBrowse5CalcFields(DataSet: TDataSet);
begin
...
procedure TInfoStokGJ3_laporanFrm.CheckBox3Click(Sender: TObject);
begin
if CheckBox3.Checked=True then
begin
Label7.Visible:=True;
...
procedure TInfoStokGJ3_laporanFrm.wwDBGrid4DblClick(Sender: TObject);
begin
...
procedure TInfoStokGJ3_laporanFrm.vTglAkhirChange(Sender: TObject);
begin
  vTglAwal.DateTime:=StartOfTheMonth(vTglAkhir.Date);
end;

procedure TInfoStokGJ3_laporanFrm.Button2Click(Sender: TObject);
begin
if CheckBox3.Checked=false then
  begin
