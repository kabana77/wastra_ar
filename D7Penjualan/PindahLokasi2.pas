...
begin
  if ((QDetailQTY3.AsFloat>0) and (QDetailQTY7.AsFloat=0)) then QDetailQTY7.AsFloat:=QDetailQTY3.AsFloat*181.44;
  if ((QDetailQTY7.AsFloat>0) and (QDetailQTY3.AsFloat=0)) then QDetailQTY3.AsFloat:=QDetailQTY7.AsFloat/181.44;
  if ((QDetailQTY3.AsFloat>0) and (QDetailQTY7.AsFloat>0)) then QDetailQTY7.AsFloat:=QDetailQTY3.AsFloat*181.44;
